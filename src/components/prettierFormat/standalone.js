;(function (t) {
  ...
  var Me = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    rr = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let o of Fu(t))
          !du.call(e, o) && o !== r && $e(e, o, { get: () => t[o], enumerable: !(n = fu(t, o)) || n.enumerable })
      return e
    }
  var he = (e, t, r) => (
      (r = e != null ? lu(pu(e)) : {}),
      rr(t || !e || !e.__esModule ? $e(r, 'default', { value: e, enumerable: !0 }) : r, e)
    ),
    nr = (e) => rr($e({}, '__esModule', { value: !0 }), e)
  var Eu = (e, t, r) => {
  ...
  var ce = (e, t, r) => (Eu(e, t, 'access private method'), r)
  var or = Me((gt) => {
    'use strict'
          ...
          for (var F = -1 * a; F <= a; F += 2) {
            ...
            if (
              (!h || (B && E.newPos < C.newPos)
                ? ((m = gu(C)), u.pushComponent(m.components, void 0, !0))
                : ((m = E), m.newPos++, u.pushComponent(m.components, !0, void 0)),
              (g = u.extractCommon(m, r, t, F)),
              m.newPos + 1 >= s && g + 1 >= D)
            )
              return i(hu(u, m.components, r, t, u.useLongestToken))
            d[F] = m
          }
          a++
        }
  ...
  var Pe = Me((ps, jr) => {
    'use strict'
    var Yr = new Proxy(String, { get: () => Yr })
    jr.exports = Yr
  })
  var Fn = {}
  We(Fn, { default: () => no, shouldHighlight: () => ro })
  var ro,
    no,
    pn = mu(() => {
      ;(ro = () => !1), (no = String)
  ...
  var yn = Me((Ft) => {
    ...
    function oo(e) {
      if (e) {
        var t
        return (t = jt) != null || (jt = new mn.default.constructor({ enabled: !0, level: 1 })), jt
      }
      return mn.default
    }
    var En = !1
    ...
    function gn(e, t, r = {}) {
      let n = (r.highlightCode || r.forceColor) && (0, dn.shouldHighlight)(r),
        o = oo(r.forceColor),
        u = io(o),
        i = (F, m) => (n ? F(m) : m),
        s = e.split(Cn),
        { start: D, end: a, markerLines: c } = so(t, s, r),
        d = t.start && typeof t.start.column == 'number',
        f = String(a).length,
        l = (n ? (0, dn.default)(e, r) : e)
          .split(Cn, a)
          .slice(D, a)
          .map((F, m) => {
            let E = D + 1 + m,
            ...
            if (h) {
              let Z = ''
              if (Array.isArray(h)) {
                let $ = F.slice(0, Math.max(h[0] - 1, 0)).replace(/[^\t]/g, ' '),
                  Q = h[1] || 1
                ;(Z = [
                  `
 `,
...
${l}`),
    ...
    function Do(e, t, r, n = {}) {
      ...
      return (r = Math.max(r, 0)), gn(e, { start: { column: r, line: t } }, n)
    }
  })
  var ri = {}
  We(ri, {
  ...
  var M = 'string',
    ...
    O = 'label',
    b = 'break-parent',
    Ue = new Set([W, T, S, v, _, k, x, P, L, I, A, O, b])
  function _u(e) {
...
Expected it to be ${n}.`
  ...
  function oe(e, t) {
    return z(t), { type: S, contents: t, n: e }
  }
  function At(e, t = {}) {
    return (
      z(e),
      ze(t.expandedStates, !0),
      { type: _, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
    )
  }
  function ar(e) {
  ...
  function Fr(e, t = '', r = {}) {
    return z(e), t !== '' && z(t), { type: x, breakContents: e, flatContents: t, groupId: r.groupId }
  }
  function pr(e, t) {
...
`
  ...
  function kr(e) {
    for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === A && y(!1, e, -1).type === b; ) e.length -= 2
    if (e.length > 0) {
      let t = Oe(y(!1, e, -1))
      e[e.length - 1] = t
    }
    ...
    for (; r >= 0; ) {
      ...
      switch (U(c)) {
        ...
        case _: {
          ...
          let d = c.break ? R : a,
            f = c.expandedStates && d === R ? y(!1, c.expandedStates, -1) : c.contents
          s.push({ mode: d, doc: f })
          break
        }
        case x: {
...
`,
        ...
        case W:
          ...
          break
        case T:
          i.push({ ind: Iu(f, t), mode: p, doc: l.contents })
          break
        case S:
          i.push({ ind: Ru(f, l.n, t), mode: p, doc: l.contents })
          break
        case v:
          u -= kt(s)
          break
        ...
        case k: {
          ...
          let Q = { ind: f, mode: p, doc: Ge(m) },
            tr = m[0]
          Qe({ ind: f, mode: K, doc: [E, C, tr] }, [], F, a.length > 0, r, !0)
            ? i.push(Q, Z, g)
            : B
              ? i.push(Q, $, g)
              : i.push(Q, $, h)
        ...
        case L:
          ...
          break
        case I:
          a.length > 0 && i.push({ ind: f, mode: p, doc: _e })
          break
        case A:
          switch (p) {
            case K:
  ...
  function J(e) {
    ...
    return e.type === x
      ? { ...e, breakContents: J(e.breakContents), flatContents: J(e.flatContents) }
      : e.type === _
        ? { ...e, contents: J(e.contents), expandedStates: (t = e.expandedStates) == null ? void 0 : t.map(J) }
        : e.type === k
  ...
  function Pr(e) {
    ...
    function n(u, i, s) {
      ...
      if (u.type === b)
        return ((a = s == null ? void 0 : s[i - 1]) == null ? void 0 : a.type) === A && s[i - 1].hard
          ? void 0
          : 'breakParent'
...
in order for it to be formatted.`,
  ...
  function et({ plugins: e = [], showDeprecated: t = !1 } = {}) {
    let r = e.flatMap((o) => o.languages ?? []),
      n = []
    for (let o of Vu(Object.assign({}, ...e.map(({ options: u }) => u), Lr)))
      (!t && o.deprecated) ||
        (Array.isArray(o.choices) &&
          (t || (o.choices = o.choices.filter((u) => !u.deprecated)),
          o.name === 'parser' && (o.choices = [...o.choices, ...ju(o.choices, r, e)])),
  ...
  var $u = (e) => String(e).split(/[/\\]/).pop()
  function Ir(e, t) {
    if (!t) return
    let r = $u(t).toLowerCase()
    return e.find((n) => {
      var o, u
      return (
  ...
  function Wu(e, t) {
    let r = e.plugins.flatMap((o) => o.languages ?? []),
      n = Mu(r, t.language) ?? Ir(r, t.physicalFile) ?? Ir(r, t.file) ?? (t.physicalFile, void 0)
  ...
  var bt = he(Pe(), 1),
    Vr = (e, t, { descriptor: r }) => {
      ...
      return (
        t && n.push(`we now treat it as ${bt.default.blue(typeof t == 'string' ? r.key(t) : r.pair(t))}`),
        n.join('; ') + '.'
      )
    }
  var se = he(Pe(), 1)
  var tt = Symbol.for('vnopts.VALUE_NOT_EXIST'),
    pe = Symbol.for('vnopts.VALUE_UNCHANGED')
  var $r = ' '.repeat(2),
    Wr = (e, t, r) => {
      let { text: n, list: o } = r.normalizeExpectedResult(r.schemas[e].expected(r)),
        u = []
      return (
        n && u.push(Mr(e, t, n, r.descriptor)),
        o &&
          u.push(
            [Mr(e, t, o.title, r.descriptor)].concat(o.values.map((i) => Ur(i, r.loggerPrintWidth))).join(`
`)
          ),
      ...
      t &&
        n.push(
          [`- ${se.default.blue(t.title)}:`].concat(
            t.values.map((o) => Ur(o, r - $r.length).replace(/^|\n/g, `$&${$r}`))
          ).join(`
`)
        ),
      zr(n, r)
...
`,
  ...
  function Ot(e, t) {
    ...
    for (; d < o; )
      for (i = t.charCodeAt(u + d), D = d++, s = d, c = 0; c < n; c++)
        (a = i === Gr[c] ? D : D + 1), (D = wt[c]), (s = wt[c] = D > s ? (a > s ? s + 1 : a) : a > D ? D + 1 : a)
    return s
  }
  var rt = (e, t, { descriptor: r, logger: n, schemas: o }) => {
    let u = [`Ignored unknown option ${Nt.default.yellow(r.pair({ key: e, value: t }))}.`],
      i = Object.keys(o)
        .sort()
        .find((s) => Ot(e, s) < 3)
  ...
  function zu(e, t) {
    let r = new e(t),
      n = Object.create(r)
    for (let o of Uu) o in t && (n[o] = Gu(t[o], r, w.prototype[o].length))
    return n
  }
  var w = class {
    static create(t) {
  ...
  function St(e) {
    ...
    let { text: t, list: r } = e
    return (
      Ku((t || r) !== void 0, 'Unexpected `expected` result, there should be at least one field.'),
      r ? { text: t, list: { title: r.title, values: r.values.map(St) } } : { text: t }
    )
  }
  function vt(e, t) {
  ...
  function st(e, t) {
    return e === void 0 ? [] : Array.isArray(e) ? e.map((r) => Hr(r, t)) : [Hr(e, t)]
  }
  function Lt(e, t) {
  ...
  var lt = class {
    ...
    _applyRequiredCheck(t) {
      for (let r of Object.keys(this._utils.schemas))
        if (this._identifyMissing(r, t) && this._identifyRequired(r)) throw this._invalidHandler(r, tt, this._utils)
    }
  ...
  var It
  function qu(e, t, { logger: r = !1, isCLI: n = !1, passThrough: o = !1, FlagSchema: u, descriptor: i } = {}) {
    if (n) {
    ...
    let s = o
        ...
        : (f, p, l) => {
            let { _: F, ...m } = l.schemas
            return rt(f, p, { ...l, schemas: m })
          },
      D = Ju(t, { isCLI: n, FlagSchema: u }),
  ...
  function Ju(e, { isCLI: t, FlagSchema: r }) {
    let n = []
    t && n.push(ut.create({ name: '_' }))
    for (let o of e)
      n.push(Xu(o, { isCLI: t, optionInfos: e, FlagSchema: r })),
        o.alias && t && n.push(nt.create({ name: o.alias, sourceName: o.name }))
    return n
  }
  function Xu(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
    let { name: o } = e,
      u = { name: o },
      i,
      s = {}
    ...
    return e.array
      ? ot.create({ ...(t ? { preprocess: (D) => (Array.isArray(D) ? D : [D]) } : {}), ...s, valueSchema: i.create(u) })
      : i.create({ ...u, ...s })
  }
  var sn = qu
  function Rt(e, t) {
  ...
  async function Zu(e, t = {}) {
    ...
    let n = et({ plugins: e.plugins, showDeprecated: !0 }).options,
      o = { ...cn, ...Object.fromEntries(n.filter((f) => f.default !== void 0).map((f) => [f.name, f.default])) },
      u = Rt(r.plugins, r.parser),
      i = await Yt(u, r.parser)
    ;(r.astFormat = i.astFormat), (r.locEnd = i.locEnd), (r.locStart = i.locStart)
    let s = (d = u.printers) != null && d[i.astFormat] ? u : Dn(r.plugins, i.astFormat),
      D = await an(s, i.astFormat)
    r.printer = D
    ...
    return r.parser === 'json' && (r.trailingComma = 'none'), sn(r, n, { passThrough: Object.keys(cn), ...t })
  }
  var re = Zu
  var ln = new Set(['tokens', 'comments', 'parent', 'enclosingNode', 'precedingNode', 'followingNode']),
    Qu = (e) => Object.keys(e).filter((t) => !ln.has(t))
  function eo(e) {
    return e ? (t) => e(t, ln) : Qu
  }
  var H = eo
  function to(e, t) {
    let {
  ...
  function co(e, t) {
    let { loc: r } = e
    if (r) {
      let n = (0, An.codeFrameColumns)(t, r, { highlightCode: !0 })
      throw (
        ((e.message +=
          `
` + n),
...
` ||
  ...
  function Et(e, t) {
    ...
    if (!n) return []
    let s = ((r == null ? void 0 : r(e, t)) ?? [...Wt(e, { getVisitorKeys: H(o) })]).flatMap((D) =>
      n(D) ? [D] : Et(D, t)
    )
  ...
  function Nn(e, t) {
    ...
    for (let [p, l] of f.entries()) {
      ...
      let $
      if (
        (i ? ($ = [l]) : ((F.enclosingNode = E), (F.precedingNode = m), (F.followingNode = C), ($ = [F, g, h, B, Z])),
        Eo(g, h, f, p))
      )
        (F.placement = 'ownLine'), a(...$) || (C ? ne(C, F) : m ? ue(m, F) : E ? X(E, F) : X(B, F))
      else if (Co(g, h, f, p))
        (F.placement = 'endOfLine'), c(...$) || (m ? ue(m, F) : C ? ne(C, F) : E ? X(E, F) : X(B, F))
  ...
  function ho(e, t) {
    let r = t - 1
    ;(r = N(e, r, { backwards: !0 })), (r = Y(e, r, { backwards: !0 })), (r = N(e, r, { backwards: !0 }))
  ...
  function yo(e, t, r) {
    ...
    if ((r != null && r.hasLineSuffix && !(r != null && r.isBlock)) || V(i, s(n), { backwards: !0 })) {
      let c = Ye(i, s(n))
      return { doc: Be([G, c ? G : '', o]), isBlock: D, hasLineSuffix: !0 }
    }
    return !D || (r != null && r.hasLineSuffix)
      ? { doc: [Be([' ', o]), le], isBlock: D, hasLineSuffix: !0 }
  ...
  function Ao(e, t) {
    ...
    return (
      e.each(() => {
        ...
        a ? u.push(go(e, t)) : c && ((s = yo(e, t, s)), i.push(s.doc))
      }, 'comments'),
      { leading: u, trailing: i }
    )
  }
  function vn(e, t, r) {
    let { leading: n, trailing: o } = Ao(e, r)
  ...
  async function Bo(e, t, r, n) {
    let o = await re({ ...r, ...t, parentParser: r.parser, originalText: e }, { passThrough: !0 }),
      { ast: u } = await De(e, o),
      i = await n(u, o)
    return Xe(i)
  }
    ...
    return (
      (D = i.hasPrettierIgnore) != null && D.call(i, e)
        ...
        : o.has(u)
          ? (s = o.get(u))
          : (s = i.print(e, t, r, n)),
      u === t.cursorNode && (s = Ze(s, (a) => [xe, a, xe])),
      i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t)) && (s = vn(e, s, t)),
      s
    )
  }
  ...
  var ko = ({ parser: e }) => e === 'json' || e === 'json5' || e === 'json-stringify'
  function bo(e, t) {
  ...
  function wo(e, t, { locStart: r, locEnd: n }) {
    let o = e.node,
      u = t.node
    if (o === u) return { startNode: o, endNode: u }
    let i = r(e.node)
    for (let D of jn(t.parentNodes))
      if (r(D) >= i) u = D
      else break
    let s = n(t.node)
  ...
  function Vn(e, t, r) {
    ...
    switch (e.parser) {
      ...
      case 'meriyah':
      case '__babel_estree':
        return Oo(t.type, r == null ? void 0 : r.type)
      case 'json':
      case 'json5':
      case 'json-stringify':
        return $n.has(t.type)
      case 'graphql':
        return No.has(t.kind)
      case 'vue':
        return t.tag !== 'root'
    }
    return !1
  ...
  function Mn(e, t, r) {
    ...
    let a = qt(r, n, t, (p, l) => Vn(t, p, l), [], 'rangeStart'),
      c = D ? a : qt(r, o, t, (p) => Vn(t, p), [], 'rangeEnd')
    if (!a || !c) return { rangeStart: 0, rangeEnd: 0 }
    let d, f
    if (ko(t)) {
      let p = bo(a, c)
      ;(d = p), (f = p)
    } else ({ startNode: d, endNode: f } = wo(a, c, t))
      ...
      if (
        (t.cursorNode && i.cursorNodeText
          ? ((D = t.locStart(t.cursorNode)),
            ...
            (d = i.cursorNodeStart),
            (f = i.cursorNodeText))
          : ((D = 0), (a = o), (c = t.cursorOffset), (d = 0), (f = i.formatted)),
        a === f)
      )
  ...
  async function So(e, t) {
    let { ast: r, text: n } = await De(e, t),
      { rangeStart: o, rangeEnd: u } = Mn(n, t, r),
      i = n.slice(o, u),
      s = Math.min(
        o,
        n.lastIndexOf(
...
`,
  ...
  function Jn(e, t) {
    let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u } = zn(e, t),
      i = e.charAt(0) === Hn
...
`
    ...
    return { hasBOM: i, text: e, options: zn(e, { ...t, cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u }) }
  }
  ...
  async function Xt(e, t) {
    ...
    if ((o.rangeStart >= o.rangeEnd && n !== '') || (o.requirePragma && !(await Gn(n, o))))
    ...
    return (
      o.rangeStart > 0 || o.rangeEnd < n.length
        ...
        : (!o.requirePragma &&
          ...
          (u = await qn(n, o))),
      r && ((u.formatted = Hn + u.formatted), u.cursorOffset >= 0 && u.cursorOffset++),
      u
    )
  }
  async function Xn(e, t, r) {
    let { text: n, options: o } = Jn(e, await re(t)),
      u = await De(n, o)
  ...
  async function Qn(e, t) {
    let r = Pr(e),
      { formatted: n } = await Xt(r, { ...t, parser: '__js_expression' })
    return n
  }
  ...
  We(Qt, {
    ...
    getNextNonSpaceNonCommentCharacterIndex: () => zo,
    getStringWidth: () => we,
    hasNewline: () => V,
...
`
  ...
  function zo(e, t) {
    return arguments.length === 2 || typeof t == 'number' ? Ve(e, t) : Uo(...arguments)
  }
  function Go(e, t, r) {
    return Ye(e, r(t))
  }
  function Ko(e, t) {
    return arguments.length === 2 || typeof t == 'number' ? Ye(e, t) : Go(...arguments)
  }
  function Ho(e, t, r) {
    return Ct(e, r(t))
  }
  function qo(e, t) {
    return arguments.length === 2 || typeof t == 'number' ? Ct(e, t) : Ho(...arguments)
  }
  var er = {}
  We(er, { builders: () => Jo, printer: () => Xo, utils: () => Zo })
  var Jo = {
      join: ke,
      line: Ke,
      softline: Er,
  ...
  async function cu(e, t) {
    let { formatted: r } = await au(e, { ...t, cursorOffset: -1 })
    return r
  }
  ...
  var ei = ae(et, 0),
    ti = { parse: ae(Xn), formatAST: ae(Zn), formatDoc: ae(Qn), printToDoc: ae(eu), printDocToString: ae(tu) }
  return nr(ri)
})
