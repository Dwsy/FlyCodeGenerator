;(function (f) {
  ...
  var Lt = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
    Qs = (a, t) => {
      for (var e in t) Ce(a, e, { get: t[e], enumerable: !0 })
    },
    Dt = (a, t, e, s) => {
  ...
  var qe = (a, t, e) => (
      (e = a != null ? Ws(Gs(a)) : {}),
      Dt(t || !a || !a.__esModule ? Ce(e, 'default', { value: a, enumerable: !0 }) : e, a)
    ),
    Zs = (a) => Dt(Ce({}, '__esModule', { value: !0 }), a)
  var Ct = Lt((ge) => {
    'use strict'
    ...
    var Mt = 'BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED',
      ei = {
        ImportMetaOutsideModule: { message: `import.meta may appear only with 'sourceType: "module"'`, code: Mt },
        ImportOutsideModule: { message: `'import' and 'export' may appear only with 'sourceType: "module"'`, code: Mt }
      },
      Ot = {
      ...
      Ne = ({ type: a, prefix: t }) => (a === 'UpdateExpression' ? Ot.UpdateExpression[String(t)] : Ot[a]),
      ti = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
        ...
        InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Ne(a)}.`,
        InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${Ne(a)}.`,
        InvalidLhsOptionalChaining: ({ ancestor: a }) => `Invalid optional chaining in the left-hand side of ${Ne(a)}.`,
      ...
      ii = new Set(['ArrowFunctionExpression', 'AssignmentExpression', 'ConditionalExpression', 'YieldExpression']),
      ri = {
        PipeBodyIsTighter:
        ...
        PipeUnparenthesizedBody: ({ type: a }) =>
          `Hack-style pipe body cannot be an unparenthesized ${Ne({ type: a })}; please wrap it in parentheses.`,
        PipelineBodyNoArrow:
    ...
    function oi(a) {
      ...
      return function s({ loc: i, details: r }) {
        ...
        return (
          Object.assign(n, e, { loc: i, pos: i.index }),
          'missingPlugin' in r && Object.assign(n, { missingPlugin: r.missingPlugin }),
    ...
    function $(a, t) {
      ...
      for (let s of Object.keys(a)) {
        let i = a[s],
          r = typeof i == 'string' ? { message: () => i } : typeof i == 'function' ? { message: i } : i,
          { message: n } = r,
          o = De(r, ni),
    ...
    var p = Object.assign({}, $(ei), $(ti), $(si), $`pipelineOperator`(ri)),
      { defineProperty: hi } = Object,
      Bt = (a, t) => hi(a, t, { enumerable: !1, value: a[t] })
    function le(a) {
    ...
    var li = (a) =>
        class extends a {
          ...
          directiveToStmt(e) {
            ...
            let i = e
            return (
              (i.type = 'ExpressionStatement'), (i.expression = s), (i.directive = s.extra.rawValue), delete s.extra, i
            )
          }
          initFunction(e, s) {
          ...
          parseClassPrivateProperty(...e) {
            ...
            return (
              this.getPluginOption('estree', 'classFeatures') && ((s.type = 'PropertyDefinition'), (s.computed = !1)), s
            )
          }
            ...
            switch (r.type) {
              ...
              case 'ExportNamedDeclaration':
                r.specifiers.length === 1 &&
                  ...
                  ((r.type = 'ExportAllDeclaration'), (r.exported = r.specifiers[0].exported), delete r.specifiers)
      ...
      w = { brace: new X('{'), j_oTag: new X('<tag'), j_cTag: new X('</tag'), j_expr: new X('<tag>...</tag>', !0) }
    w.template = new X('`', !0)
    var b = !0,
      m = !0,
      ze = !0,
    ...
    function P(a, t = {}) {
      ...
      return (
        ++de,
        yt.push(a),
        xt.push((e = t.binop) != null ? e : -1),
        Pt.push((s = t.beforeExpr) != null ? s : !1),
        gt.push((i = t.startsExpr) != null ? i : !1),
        Tt.push((r = t.prefix) != null ? r : !1),
        U.push(new Me(a, t)),
        de
      )
    }
    ...
    var pi = {
      ...
      eq: P('=', { beforeExpr: b, isAssign: ce }),
      assign: P('_=', { beforeExpr: b, isAssign: ce }),
      slashAssign: P('_=', { beforeExpr: b, isAssign: ce }),
      xorAssign: P('_=', { beforeExpr: b, isAssign: ce }),
      moduloAssign: P('_=', { beforeExpr: b, isAssign: ce }),
      incDec: P('++/--', { prefix: q, postfix: ci, startsExpr: m }),
      bang: P('!', { beforeExpr: b, prefix: q, startsExpr: m }),
      tilde: P('~', { beforeExpr: b, prefix: q, startsExpr: m }),
      ...
      bitShiftL: v('<</>>/>>>', 8),
      bitShiftR: v('<</>>/>>>', 8),
      plusMin: P('+/-', { beforeExpr: b, binop: 9, prefix: q, startsExpr: m }),
      ...
      _switch: A('switch'),
      _throw: A('throw', { beforeExpr: b, prefix: q, startsExpr: m }),
      _try: A('try'),
      _var: A('var'),
      _const: A('const'),
      _with: A('with'),
      ...
      _typeof: A('typeof', { beforeExpr: b, prefix: q, startsExpr: m }),
      _void: A('void', { beforeExpr: b, prefix: q, startsExpr: m }),
      _delete: A('delete', { beforeExpr: b, prefix: q, startsExpr: m }),
      _do: A('do', { isLoop: ze, beforeExpr: b }),
      _for: A('for', { isLoop: ze }),
      _while: A('while', { isLoop: ze }),
    ...
    var Yt = [
        ...
        2, 3, 2, 3, 2, 0, 2, 9, 2, 16, 6, 2, 2, 4, 2, 16, 4421, 42719, 33, 4153, 7, 221, 3, 5761, 15, 7472, 16, 621,
        ...
        : a <= 90
          ...
          : a < 97
            ...
            : a <= 122
              ? !0
              : a <= 65535
                ? a >= 170 && Ai.test(String.fromCharCode(a))
                : Ge(a, Yt)
    }
    function Z(a) {
      return a < 48
            ...
            : a <= 90
              ...
              : a < 97
                ...
                : a <= 122
                  ? !0
                  : a <= 65535
                    ? a >= 170 && Si.test(String.fromCharCode(a))
                    : Ge(a, Yt) || Ge(a, wi)
    }
    var St = {
        keyword: [
      ...
      Ci = new Set(St.keyword),
      Ei = new Set(St.strict),
      Ii = new Set(St.strictBind)
    function Qt(a, t) {
          ...
          return s & 1
            ? s & 8
              ...
              : s & 16
                ...
                : (t.lexical.has(e) && !(t.flags & 8 && t.lexical.values().next().value === e)) ||
    ...
    var tt = class a {
      ...
      Ut = { decBinOct: new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: new Set([46, 88, 95, 120]) },
      Ie = {
        bin: (a) => a === 48 || a === 49,
        oct: (a) => a >= 48 && a <= 55,
        dec: (a) => a >= 48 && a <= 57,
    ...
    function jt(a, t, e, s, i, r) {
      ...
      for (;;) {
        ...
        if (d === 92) {
          ...
          y.ch === null && !c ? (c = { pos: e, lineStart: s, curLine: i }) : (l += y.ch),
            ({ pos: e, lineStart: s, curLine: i } = y),
            (u = e)
        } else
          d === 8232 || d === 8233
            ? (++e, ++i, (s = e))
...
`)
        ...
        case 120: {
          let l
          return ({ code: l, pos: t } = st(a, t, e, s, 2, !1, n, r)), o(l === null ? null : String.fromCharCode(l))
        }
        case 117: {
          let l
    ...
    function st(a, t, e, s, i, r, n, o) {
      let h = t,
        l
      return (
        ({ n: l, pos: t } = rs(a, t, e, s, 16, i, r, !1, o, !n)),
    ...
    function rs(a, t, e, s, i, r, n, o, h, l) {
      let c = t,
        u = i === 16 ? Ut.hex : Ut.decBinOct,
        f = i === 16 ? Ie.hex : i === 10 ? Ie.dec : i === 8 ? Ie.oct : Ie.bin,
        d = !1,
        y = 0
    ...
    function as(a, t, e, s, i, r) {
      ...
      if (n === 123) {
        if (
          (++t, ({ code: o, pos: t } = st(a, t, e, s, a.indexOf('}', t) - t, !0, i, r)), ++t, o !== null && o > 1114111)
        )
          if (i) r.invalidCodePoint(t, e, s)
          else return { code: null, pos: t }
      } else ({ code: o, pos: t } = st(a, t, e, s, 4, !1, i, r))
      return { code: o, pos: t }
    }
    var Ri = ['at'],
      _i = ['at']
    ...
    var Ui = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
      O = class {
        constructor(t) {
          ;(this.type = t.type),
            (this.value = t.value),
            (this.start = t.start),
            (this.end = t.end),
            (this.loc = new te(t.startLoc, t.endLoc))
        }
      },
      it = class extends et {
        constructor(t, e) {
          super(),
            ...
            (this.errorHandlers_readInt = {
              invalidDigit: (s, i, r, n) =>
                this.options.errorRecovery ? (this.raise(p.InvalidDigit, { at: ue(s, i, r), radix: n }), !0) : !1,
        ...
        setStrict(t) {
          ;(this.state.strict = t),
            t &&
              (this.state.strictErrors.forEach(([e, s]) => this.raise(e, { at: s })), this.state.strictErrors.clear())
        }
        curContext() {
        ...
        skipBlockComment(t) {
          ...
          if (i === -1) throw this.raise(p.UnterminatedComment, { at: this.state.curPosition() })
        ...
        skipLineComment(t) {
          ...
          if (this.state.pos < this.length)
            for (; !me(i) && ++this.state.pos < this.length; ) i = this.input.charCodeAt(this.state.pos)
          if (this.isLookahead) return
        ...
        skipSpace() {
          ...
          if (e.length > 0) {
            let s = this.state.pos,
              i = { start: t, end: s, comments: e, leadingNode: null, trailingNode: null, containingNode: null }
        ...
        readToken_numberSign() {
          ...
          if (e >= 48 && e <= 57) throw this.raise(p.UnexpectedDigitAfterHash, { at: this.state.curPosition() })
        ...
        readRegexp() {
          let t = this.state.startLoc,
            ...
            { pos: r } = this.state
          for (; ; ++r) {
            if (r >= this.length) throw this.raise(p.UnterminatedRegExp, { at: L(t, 1) })
            let l = this.input.charCodeAt(r)
            if (me(l)) throw this.raise(p.UnterminatedRegExp, { at: L(t, 1) })
            if (s) s = !1
            else {
              if (l === 91) i = !0
              else if (l === 93 && i) i = !1
          ...
          for (; r < this.length; ) {
            ...
            if (Ui.has(l))
              l === 118
                ? o.includes('u') && this.raise(p.IncompatibleRegExpUVFlags, { at: h() })
                : l === 117 && o.includes('v') && this.raise(p.IncompatibleRegExpUVFlags, { at: h() }),
                o.includes(c) && this.raise(p.DuplicateRegExpFlags, { at: h() })
            else if (Z(l) || l === 92) this.raise(p.MalformedRegExpFlags, { at: h() })
            else break
            ++r, (o += c)
          }
        ...
        readNumber(t) {
          ...
          if (
            (c === 46 &&
              !h &&
              (++this.state.pos, this.readInt(10), (i = !0), (c = this.input.charCodeAt(this.state.pos))),
            (c === 69 || c === 101) &&
              !h &&
              ((c = this.input.charCodeAt(++this.state.pos)),
              (c === 43 || c === 45) && ++this.state.pos,
              this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, { at: s }),
              (i = !0),
              (o = !0),
              (c = this.input.charCodeAt(this.state.pos))),
            c === 110 && ((i || l) && this.raise(p.InvalidBigIntLiteral, { at: s }), ++this.state.pos, (r = !0)),
            c === 109 &&
        ...
        readTemplateToken() {
          ...
          ;(this.state.pos = i + 1),
            ...
            s && (this.state.firstInvalidTemplateEscapePos = new F(s.curLine, s.pos - s.lineStart, s.pos)),
        ...
        readWord1(t) {
          ...
          for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
            ...
            if (Z(r)) this.state.pos += r <= 65535 ? 1 : 2
              ...
              h !== null &&
                (o(h) || this.raise(p.EscapedCharNotAnIdentifier, { at: n }), (e += String.fromCodePoint(h))),
                (i = this.state.pos)
            } else break
          }
        ...
        checkKeywordEscapes() {
          ...
          bt(t) &&
            ...
            this.raise(p.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: H(t) })
        }
        raise(t, e) {
          let { at: s } = e,
            i = De(e, Ri),
      ...
      at = class {
        ...
        exit() {
          ...
          for (let [s, i] of Array.from(t.undefinedPrivateNames))
            e
              ...
              : this.parser.raise(p.InvalidPrivateFieldResolution, { at: i, identifierName: s })
        }
        ...
        usePrivateName(t, e) {
          ...
          s
            ...
            : this.parser.raise(p.InvalidPrivateFieldResolution, { at: e, identifierName: t })
        }
      },
      se = class {
        constructor(t = 0) {
    ...
    var ht = class extends it {
        ...
        checkExpressionErrors(t, e) {
          if (!t) return !1
          let { shorthandAssignLoc: s, doubleProtoLoc: i, privateKeyLoc: r, optionalParametersLoc: n } = t,
            o = !!s || !!i || !!n || !!r
          if (!e) return o
        ...
        hasPropertyAsPrivateName(t) {
          return (
            (t.type === 'MemberExpression' || t.type === 'OptionalMemberExpression') && this.isPrivateName(t.property)
          )
        }
        isObjectProperty(t) {
        ...
        initializeScopes(t = this.options.sourceType === 'module') {
          ...
          return (
            (this.expressionScope = new nt(this)),
            () => {
              ;(this.state.labels = e),
      ...
      wt = ie.prototype
    wt.__clone = function () {
      let a = new ie(void 0, this.start, this.loc.start),
        t = Object.keys(this)
    ...
    function Hi(a) {
      return (
        ...
        (a.type === 'DeclareExportDeclaration' &&
          (!a.declaration || (a.declaration.type !== 'TypeAlias' && a.declaration.type !== 'InterfaceDeclaration')))
      )
    }
    function $t(a) {
    ...
    var Xi = /\*?\s*@((?:no)?flow)\b/,
      Gi = (a) =>
        class extends a {
          ...
          finishToken(e, s) {
            e !== 133 && e !== 13 && e !== 28 && this.flowPragma === void 0 && (this.flowPragma = null),
          ...
          flowParsePredicate() {
            ...
            return (
              ...
              this.state.lastTokStart > s.index + 1 && this.raise(g.UnexpectedSpaceBetweenModuloChecks, { at: s }),
              this.eat(10)
                ? ((e.value = super.parseExpression()), this.expect(11), this.finishNode(e, 'DeclaredPredicate'))
          ...
          flowParseDeclare(e, s) {
            ...
            if (this.eatContextual(127))
              return this.match(16)
                ...
                : (s && this.raise(g.NestedDeclareModule, { at: this.state.lastTokStartLoc }),
          ...
          flowParseDeclareModule(e) {
              ...
              this.match(83)
                ? (this.next(),
                  !this.isContextual(130) &&
                    !this.match(87) &&
                    this.raise(g.InvalidNonTypeImportInDeclareModule, { at: this.state.lastTokStartLoc }),
                  super.parseImport(o))
            ...
            return (
              i.forEach((o) => {
                Hi(o)
                  ? (r === 'CommonJS' && this.raise(g.AmbiguousDeclareModuleKind, { at: o }), (r = 'ES'))
                  : o.type === 'DeclareModuleExports' &&
                    (n && this.raise(g.DuplicateDeclareModuleExports, { at: o }),
                    r === 'ES' && this.raise(g.AmbiguousDeclareModuleKind, { at: o }),
                    (r = 'CommonJS'),
                    (n = !0))
              }),
              (e.kind = r || 'CommonJS'),
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            let l,
              ...
              u = !1
            for (
              s && this.match(6) ? (this.expect(6), (l = 9), (c = !0)) : (this.expect(5), (l = 8), (c = !1)),
                h.exact = c;
              !this.match(l);
              ...
              if (this.eat(0))
                y != null && this.unexpected(y),
                  this.eat(0)
                    ? (E && this.unexpected(E.loc.start),
                      h.internalSlots.push(this.flowParseObjectTypeInternalSlot(C, d)))
                    : h.indexers.push(this.flowParseObjectTypeIndexer(C, d, E))
              else if (this.match(10) || this.match(47))
                y != null && this.unexpected(y),
                  E && this.unexpected(E.loc.start),
                  h.callProperties.push(this.flowParseObjectTypeCallProperty(C, d))
              else {
                let k = 'init'
                ...
                we === null ? ((u = !0), (I = this.state.lastTokStartLoc)) : h.properties.push(we)
              }
              this.flowObjectTypeSemicolon(),
                I && !this.match(8) && !this.match(9) && this.raise(g.UnexpectedExplicitInexactInObject, { at: I })
            }
          ...
          flowParseObjectTypeProperty(e, s, i, r, n, o, h) {
            if (this.eat(21))
              return this.match(12) || this.match(13) || this.match(8) || this.match(9)
                ? (o
                    ? h || this.raise(g.InexactInsideExact, { at: this.state.lastTokStartLoc })
                    : this.raise(g.InexactInsideNonObject, { at: this.state.lastTokStartLoc }),
                  r && this.raise(g.InexactVariance, { at: r }),
                  null)
                : (o || this.raise(g.UnexpectedSpreadType, { at: this.state.lastTokStartLoc }),
                ...
                this.match(47) || this.match(10)
                  ? ((e.method = !0),
                    ...
                    !o &&
                      ...
                      e.value.this &&
                      this.raise(g.ThisParamBannedInConstructor, { at: e.value.this }))
          ...
          flowCheckGetterSetterParams(e) {
            ...
            e.value.this &&
              this.raise(e.kind === 'get' ? g.GetterMayNotHaveThisParam : g.SetterMayNotHaveThisParam, {
                at: e.value.this
              }),
              i !== s && this.raise(e.kind === 'get' ? p.BadGetterArity : p.BadSetterArity, { at: e }),
              e.kind === 'set' && e.value.rest && this.raise(p.BadSetterRestParameter, { at: e })
          }
          ...
          flowParseTypeofType() {
            let e = this.startNode()
            return (
              this.expect(87), (e.argument = this.flowParsePrimaryType()), this.finishNode(e, 'TypeofTypeAnnotation')
            )
          }
          flowParseTupleType() {
            let e = this.startNode()
            ...
            return (
              o.type === 14 || o.type === 17
                ? (h && !e && this.raise(g.ThisParamMustBeFirst, { at: n }),
                  ...
                  this.eat(17) && ((i = !0), h && this.raise(g.ThisParamMayNotBeOptional, { at: n })),
          ...
          flowParsePrimaryType() {
            ...
            switch (this.state.type) {
              ...
              case 10:
                ...
                return (
                  r
                    ? (i = this.flowParseFunctionTypeParams([this.reinterpretTypeAsFunctionTypeParam(r)]))
                    : (i = this.flowParseFunctionTypeParams()),
                  (s.params = i.params),
                  (s.rest = i.rest),
                  (s.this = i._this),
          ...
          flowParsePostfixType() {
            ...
            for (; (this.match(0) || this.match(18)) && !this.canInsertSemicolon(); ) {
              ...
              ;(i = i || n),
                this.expect(0),
                !n && this.match(3)
                  ? ((r.elementType = s), this.next(), (s = this.finishNode(r, 'ArrayTypeAnnotation')))
                  : ((r.objectType = s),
          ...
          shouldParseExportDeclaration() {
            ...
            return Rt(e) || (this.shouldParseEnums() && e === 126)
              ? !this.state.containsEsc
          ...
          parseConditional(e, s, i) {
            ...
            if (l || u.length > 0) {
              ...
              l && c.length > 1 && this.raise(g.AmbiguousConditionalArrow, { at: r.startLoc }),
                l &&
                  c.length === 1 &&
                  ((this.state = r),
                  f.push(c[0].start),
          ...
          getArrowLikeExpressions(e, s) {
            ...
            for (; i.length !== 0; ) {
              ...
              n.type === 'ArrowFunctionExpression'
                ? (n.typeParameters || !n.returnType ? this.finishArrowValidation(n) : r.push(n), i.push(n.body))
                : n.type === 'ConditionalExpression' && (i.push(n.consequent), i.push(n.alternate))
            }
            return s
              ? (r.forEach((n) => this.finishArrowValidation(n)), [r, []])
              : Ji(r, (n) => n.params.every((o) => this.isAssignable(o, !0)))
          }
          ...
          parseClassMember(e, s, i) {
            ...
            super.parseClassMember(e, s, i),
              s.declare &&
                (s.type !== 'ClassProperty' && s.type !== 'ClassPrivateProperty' && s.type !== 'PropertyDefinition'
                  ? this.raise(g.DeclareClassElement, { at: r })
                  : s.value && this.raise(g.DeclareClassFieldInitializer, { at: s.value }))
          }
          isIterator(e) {
          ...
          readIterator() {
            ...
            ;(!this.isIterator(e) || !this.state.inType) &&
              this.raise(p.InvalidIdentifier, { at: this.state.curPosition(), identifierName: s }),
              ...
              : this.state.inType && (e === 62 || e === 60)
                ...
                : this.state.inType && e === 63
                  ? s === 46
                    ? this.finishOp(18, 2)
                    : this.finishOp(17, 1)
                  : ki(e, s, this.input.charCodeAt(this.state.pos + 2))
          ...
          parseClassPrivateProperty(e) {
            return (
              this.match(14) && (e.typeAnnotation = this.flowParseTypeAnnotation()), super.parseClassPrivateProperty(e)
            )
          }
          isClassMethod() {
          ...
          checkGetterSetterParams(e) {
            ...
            if (s.length > 0) {
              ...
              this.isThisParam(i) && e.kind === 'get'
                ...
                : this.isThisParam(i) && this.raise(g.SetterMayNotHaveThisParam, { at: i })
            }
          }
          ...
          parseAssignableListItemTypes(e) {
            return (
              this.eat(17) &&
                (e.type !== 'Identifier' && this.raise(g.PatternIsOptional, { at: e }),
                this.isThisParam(e) && this.raise(g.ThisParamMayNotBeOptional, { at: e }),
                (e.optional = !0)),
              this.match(14)
                ? (e.typeAnnotation = this.flowParseTypeAnnotation())
                : this.isThisParam(e) && this.raise(g.ThisParamAnnotationRequired, { at: e }),
              this.match(29) && this.isThisParam(e) && this.raise(g.ThisParamNoDefault, { at: e }),
          ...
          checkImportReflection(e) {
            super.checkImportReflection(e),
              e.module &&
                e.importKind !== 'value' &&
                this.raise(g.ImportReflectionHasImportType, { at: e.specifiers[0].loc.start })
          }
          parseImportSpecifierLocal(e, s, i) {
            ;(s.local = $t(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier()),
          ...
          parseImportSpecifier(e, s, i, r, n) {
            ...
            if (this.isContextual(93) && !this.isLookaheadContextual('as')) {
              ...
              if (h !== null && M(this.state.type)) (e.imported = this.parseIdentifier(!0)), (e.importKind = h)
                ...
                if (s) throw this.raise(p.ImportBindingIsString, { at: e, importName: o.value })
            ...
            let c = $t(e)
            return (
              i && c && this.raise(g.ImportTypeShorthandOnlyInPureImport, { at: e }),
            ...
            if (((i = n) != null && i.error) || this.match(47)) {
              ...
              if (c.node && this.maybeUnwrapTypeCastExpression(c.node).type === 'ArrowFunctionExpression') {
                if (!c.error && !c.aborted)
                  return (
                    c.node.async && this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, { at: l }), c.node
                  )
                u = c.node
              }
          ...
          parseTopLevel(e, s) {
            ...
            return (
              this.state.hasFlowComment && this.raise(g.UnterminatedFlowComment, { at: this.state.curPosition() }), i
            )
          }
          skipBlockComment() {
            if (this.hasPlugin('flowComments') && this.skipFlowComment()) {
              if (this.state.hasFlowComment) throw this.raise(g.NestedFlowComment, { at: this.state.startLoc })
          ...
          flowEnumMembers({ enumName: e, explicitType: s }) {
            ...
            for (; !this.match(8); ) {
              ...
              ;/^[a-z]/.test(c) &&
                ...
                i.has(c) && this.raise(g.EnumDuplicateMemberName, { at: h, memberName: c, enumName: e }),
                i.add(c)
          ...
          flowEnumParseExplicitType({ enumName: e }) {
            ...
            return (
              ...
              s !== 'boolean' &&
                ...
                s !== 'string' &&
                s !== 'symbol' &&
                this.raise(g.EnumInvalidExplicitType, { at: this.state.startLoc, enumName: e, invalidEnumType: s }),
              s
            )
          }
          flowEnumBody(e, s) {
            ...
            switch (((e.hasUnknownMembers = h), n)) {
              ...
              case 'string':
                return (
                  (e.explicitType = !0),
                  (e.members = this.flowEnumStringMembers(o.stringMembers, o.defaultedMembers, { enumName: i })),
                  this.expect(8),
              ...
              default: {
                ...
                } else return this.raise(g.EnumInconsistentMemberValues, { at: r, enumName: i }), l()
              }
            }
          }
        ...
        class extends a {
          jsxReadToken() {
            let e = '',
              s = this.state.pos
            for (;;) {
              if (this.state.pos >= this.length) throw this.raise(J.UnterminatedJsxContent, { at: this.state.startLoc })
              ...
              switch (i) {
                ...
                default:
                  me(i)
                    ? ((e += this.input.slice(s, this.state.pos)), (e += this.jsxReadNewLine(!0)), (s = this.state.pos))
                    : ++this.state.pos
              }
            }
          }
...
`))
          ...
          jsxReadString(e) {
            let s = '',
              i = ++this.state.pos
            for (;;) {
              if (this.state.pos >= this.length) throw this.raise(p.UnterminatedString, { at: this.state.startLoc })
              let r = this.input.charCodeAt(this.state.pos)
              if (r === e) break
              r === 38
                ? ((s += this.input.slice(i, this.state.pos)), (s += this.jsxReadEntity()), (i = this.state.pos))
                : me(r)
                  ? ((s += this.input.slice(i, this.state.pos)), (s += this.jsxReadNewLine(!1)), (i = this.state.pos))
                  : ++this.state.pos
            }
            ...
            switch (this.state.type) {
              case 5:
                return (
                  ...
                  e.expression.type === 'JSXEmptyExpression' && this.raise(J.AttributeIsEmpty, { at: e }),
                  e
                )
              case 142:
              case 133:
          ...
          jsxParseClosingElementAt(e) {
            ...
            return this.eat(143)
              ...
              : ((s.name = this.jsxParseElementName()), this.expect(143), this.finishNode(s, 'JSXClosingElement'))
          }
          jsxParseElementAt(e) {
            let s = this.startNodeAt(e),
              i = [],
            ...
            if (!r.selfClosing) {
              ...
              z(r) && !z(n) && n !== null
                ? this.raise(J.MissingClosingTagFragment, { at: n })
                : !z(r) && z(n)
                  ? this.raise(J.MissingClosingTagElement, { at: n, openingTagName: Q(r.name) })
                  : !z(r) &&
                    !z(n) &&
                    Q(n.name) !== Q(r.name) &&
                    this.raise(J.MissingClosingTagElement, { at: n, openingTagName: Q(r.name) })
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 142) s.splice(-2, 2, w.j_cTag), (this.state.canStartJSXElement = !1)
              ...
              ;(r === w.j_oTag && e === 56) || r === w.j_cTag
                ? (s.pop(), (this.state.canStartJSXElement = s[s.length - 1] === w.j_expr))
      ...
      pt = class extends xe {
        ...
        createScope(t) {
          return this.importsStack.push(new Set()), new ct(t)
        }
        enter(t) {
        ...
        declareName(t, e, s) {
          if (e & 4096) {
            this.hasImport(t, !0) && this.parser.raise(p.VarRedeclaration, { at: s, identifierName: t }),
          ...
          super.declareName(t, e, s),
            e & 2 &&
              (e & 1 || (this.checkRedeclarationInScope(i, t, e, s), this.maybeExportDefined(i, t)), i.types.add(t)),
            e & 256 && i.enums.add(t),
      ...
      Qi = (a, t) => Object.hasOwnProperty.call(a, t) && a[t],
      os = (a) => (a.type === 'ParenthesizedExpression' ? os(a.expression) : a),
      ut = class extends lt {
        toAssignable(t, e = !1) {
          var s, i
          let r
          switch (
            ((t.type === 'ParenthesizedExpression' || ((s = t.extra) != null && s.parenthesized)) &&
              ...
              e
                ? r.type === 'Identifier'
                  ? this.expressionScope.recordArrowParameterBindingError(p.InvalidParenthesizedAssignment, { at: t })
              ...
              for (let o = 0, h = t.properties.length, l = h - 1; o < h; o++) {
                ...
                this.toAssignableObjectExpressionProp(c, u, e),
                  u &&
                    ...
                    (n = t.extra) != null &&
                    n.trailingCommaLoc &&
                    this.raise(p.RestTrailingComma, { at: t.extra.trailingCommaLoc })
              }
              break
            case 'ObjectProperty': {
              let { key: o, value: h } = t
            ...
            case 'ArrayExpression':
              ;(t.type = 'ArrayPattern'),
                this.toAssignableList(t.elements, (i = t.extra) == null ? void 0 : i.trailingCommaLoc, e)
              break
            case 'AssignmentExpression':
              t.operator !== '=' && this.raise(p.MissingEqInAssignment, { at: t.left.loc.end }),
        ...
        toAssignableObjectExpressionProp(t, e, s) {
          if (t.type === 'ObjectMethod')
            ...
            t.type = 'RestElement'
            let i = t.argument
            this.checkToRestConversion(i, !1), this.toAssignable(i, s), e || this.raise(p.RestTrailingComma, { at: t })
        ...
        toAssignableList(t, e, s) {
          ...
          for (let r = 0; r <= i; r++) {
            ...
            if (n) {
              ...
              n.type === 'RestElement' &&
                (r < i ? this.raise(p.RestTrailingComma, { at: n }) : e && this.raise(p.RestTrailingComma, { at: e }))
            }
          }
        }
        isAssignable(t, e) {
          switch (t.type) {
            ...
            case 'ObjectExpression': {
              ...
              return t.properties.every(
                (i, r) => i.type !== 'ObjectMethod' && (r === s || i.type !== 'SpreadElement') && this.isAssignable(i)
              )
            }
            case 'ObjectProperty':
        ...
        parseSpread(t) {
          let e = this.startNode()
          return (
            this.next(), (e.argument = this.parseMaybeAssignAllowIn(t, void 0)), this.finishNode(e, 'SpreadElement')
          )
        }
        parseRestBinding() {
        ...
        parseBindingList(t, e, s) {
          ...
          for (; !this.eat(t); )
            if ((n ? (n = !1) : this.expect(12), i && this.match(12))) r.push(null)
              ...
              if (this.match(21)) {
                if (
                  (r.push(this.parseAssignableListItemTypes(this.parseRestBinding(), s)), !this.checkCommaAfterRest(e))
                ) {
                  this.expect(t)
                  break
                }
                ...
                for (
                  ...
                  this.raise(p.UnsupportedParameterDecorator, { at: this.state.startLoc });
                  this.match(26);
        ...
        checkLVal(
          t,
          { in: e, binding: s = 64, checkClashes: i = !1, strictModeChanged: r = !1, hasParenthesizedAncestor: n = !1 }
        ) {
          var o
          let h = t.type
          ...
          if (l || h === 'MemberExpression') {
            l &&
              ...
              e.type !== 'AssignmentExpression' && this.raise(p.InvalidLhsOptionalChaining, { at: t, ancestor: e })),
          ...
          let [u, f] = Array.isArray(c) ? c : [c, h === 'ParenthesizedExpression'],
            d = h === 'ArrayPattern' || h === 'ObjectPattern' ? { type: h } : e
        ...
        checkIdentifier(t, e, s = !1) {
          this.state.strict &&
            (s ? ts(t.name, this.inModule) : es(t.name)) &&
            (e === 64
              ? this.raise(p.StrictEvalArguments, { at: t, referenceName: t.name })
              : this.raise(p.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })),
            e & 8192 && t.name === 'let' && this.raise(p.LetInLexicalBinding, { at: t }),
        ...
        checkCommaAfterRest(t) {
          return this.match(12)
            ? (this.raise(this.lookaheadCharCode() === t ? p.RestTrailingComma : p.ElementAfterRest, {
                at: this.state.startLoc
              }),
              !0)
            : !1
    ...
    var ir = (a) =>
      class extends a {
        ...
        tsParseModifiers(
          {
            ...
            errorTemplate: r = x.InvalidModifierOnTypeMember
          },
          n
        ) {
          let o = (l, c, u, f) => {
            ...
            h = (l, c, u, f) => {
              ;((n[u] && c === f) || (n[f] && c === u)) &&
                this.raise(x.IncompatibleModifiers, { at: l, modifiers: [u, f] })
            }
          for (;;) {
            ...
            qt(c)
              ? n.accessibility
                ? this.raise(x.DuplicateAccessibilityModifier, { at: l, modifier: c })
                : (o(l, c, c, 'override'), o(l, c, c, 'static'), o(l, c, c, 'readonly'), (n.accessibility = c))
              : sr(c)
                ? (n[c] && this.raise(x.DuplicateModifier, { at: l, modifier: c }), (n[c] = !0), o(l, c, 'in', 'out'))
                : (Object.hasOwnProperty.call(n, c)
                    ? this.raise(x.DuplicateModifier, { at: l, modifier: c })
        ...
        tsParseDelimitedList(e, s, i) {
          return er(this.tsParseDelimitedListWorker(e, s, !0, i))
        }
        ...
        tsParseImportType() {
          ...
          return (
            this.expect(83),
            this.expect(10),
            this.match(133) || this.raise(x.UnsupportedImportTypeArgument, { at: this.state.startLoc }),
        ...
        tsParseTypeParameters(e) {
          ...
          return (
            ...
            s.params.length === 0 && this.raise(x.EmptyTypeParameters, { at: s }),
        ...
        tsParseBindingListForSignature() {
          ...
          for (let s of e) {
            ...
            ;(i === 'AssignmentPattern' || i === 'TSParameterProperty') &&
              this.raise(x.UnsupportedSignatureParameterKind, { at: s, type: i })
          }
          return e
        }
        ...
        tsParsePropertyOrMethodSignature(e, s) {
          ...
          if (this.match(10) || this.match(47)) {
            ...
            let r = i
            r.kind && this.match(47) && this.raise(x.AccesorCannotHaveTypeParameters, { at: this.state.curPosition() }),
            ...
            if (r.kind === 'get')
              r[n].length > 0 &&
                ...
                this.isThisParam(r[n][0]) &&
                  this.raise(x.AccesorCannotDeclareThisParameter, { at: this.state.curPosition() }))
            else if (r.kind === 'set') {
              if (r[n].length !== 1) this.raise(p.BadSetterArity, { at: this.state.curPosition() })
              else {
                let h = r[n][0]
                this.isThisParam(h) &&
                  this.raise(x.AccesorCannotDeclareThisParameter, { at: this.state.curPosition() }),
                  h.type === 'Identifier' &&
                    h.optional &&
                    this.raise(x.SetAccesorCannotHaveOptionalParameter, { at: this.state.curPosition() }),
                  h.type === 'RestElement' &&
                    this.raise(x.SetAccesorCannotHaveRestParameter, { at: this.state.curPosition() })
              }
            ...
            return (
              n && (r.typeAnnotation = n), this.tsParseTypeMemberSemicolon(), this.finishNode(r, 'TSPropertySignature')
            )
          }
        }
        tsParseTypeMember() {
          ...
          return (
            e.elementTypes.forEach((i) => {
              ...
              s &&
                ...
                this.raise(x.OptionalTypeBeforeRequired, { at: i }),
          ...
          if (i) {
            ...
            r
              ? ((c = this.startNodeAtNode(r)),
                ...
                (c.elementType = o),
                this.eat(17) &&
                  ((c.optional = !0), this.raise(x.TupleOptionalAfterType, { at: this.state.lastTokStartLoc })))
              : ((c = this.startNodeAtNode(o)),
                (c.optional = n),
                this.raise(x.InvalidTupleMemberLabel, { at: o }),
                (c.label = o),
            ...
            case 53:
              if (this.state.value === '-') {
                let e = this.startNode(),
                  s = this.lookahead()
                return (
                  s.type !== 134 && s.type !== 135 && this.unexpected(),
        ...
        tsParseTypeOperatorOrHigher() {
          return gi(this.state.type) && !this.state.containsEsc
        ...
        tsParseTypePredicateAsserts() {
          ...
          return (
            ...
            !S(this.state.type) && !this.match(78)
              ? !1
              : (e &&
                  this.raise(p.InvalidEscapedReservedWord, { at: this.state.lastTokStartLoc, reservedWord: 'asserts' }),
                !0)
          )
        }
        ...
        tsParseType() {
          ...
          return (
            (s.checkType = e),
            (s.extendsType = this.tsInDisallowConditionalTypesContext(() => this.tsParseNonConditionalType())),
            this.expect(17),
        ...
        tsParseTypeAssertion() {
          this.getPluginOption('typescript', 'disallowAmbiguousJSXLike') &&
            this.raise(x.ReservedTypeAssertion, { at: this.state.startLoc })
          let e = this.startNode()
          return (
        ...
        tsParseInterfaceDeclaration(e, s = {}) {
          ...
          this.expectContextual(129),
            ...
            S(this.state.type)
              ...
              : ((e.id = null), this.raise(x.MissingInterfaceName, { at: this.state.startLoc })),
        ...
        tsParseEnumMember() {
          let e = this.startNode()
          return (
            (e.id = this.match(133) ? super.parseStringLiteral(this.state.value) : this.parseIdentifier(!0)),
        ...
        tsParseImportEqualsDeclaration(e, s, i) {
          ...
          return (
            e.importKind === 'type' &&
              ...
              this.raise(x.ImportAliasHasImportType, { at: r }),
            (e.moduleReference = r),
            this.semicolon(),
        ...
        tsParseTypeArguments() {
          ...
          return (
            ...
            e.params.length === 0
              ? this.raise(x.EmptyTypeArguments, { at: e })
          ...
          if (n || h || o) {
            ...
            return (
              ...
              c.type !== 'Identifier' &&
                ...
                this.raise(x.UnsupportedParameterPropertyKind, { at: u }),
              (u.parameter = c),
        ...
        isSimpleParameter(e) {
          return (
            (e.type === 'TSParameterProperty' && super.isSimpleParameter(e.parameter)) || super.isSimpleParameter(e)
          )
        }
        tsDisallowOptionalPattern(e) {
          for (let s of e.params)
            s.type !== 'Identifier' &&
              ...
              this.raise(x.PatternIsOptional, { at: s })
        }
        ...
        parseFunctionBodyAndFinish(e, s, i = !1) {
          ...
          return r && !this.match(5) && this.isLineTerminator()
            ...
            : r === 'TSDeclareFunction' &&
                this.state.isAmbientContext &&
                (this.raise(x.DeclareFunctionHasImplementation, { at: e }), e.declare)
        ...
        tsCheckForInvalidTypeCasts(e) {
          e.forEach((s) => {
            ;(s == null ? void 0 : s.type) === 'TSTypeCastExpression' &&
              this.raise(x.UnexpectedTypeAnnotation, { at: s.typeAnnotation })
          })
        }
        toReferencedList(e, s) {
          ...
          if (this.match(47) || this.match(51)) {
            let o,
              h = this.tsTryParseAndCatch(() => {
                ...
                if (c === 48 || c === 52 || (c !== 10 && Xe(c) && !this.hasPrecedingLineBreak())) return
            ...
            if ((o && this.unexpected(o, 10), h))
              return (
                h.type === 'TSInstantiationExpression' &&
                  ...
                  this.raise(x.InvalidPropertyAccessAfterInstantiationExpression, { at: this.state.startLoc }),
                h
              )
          }
          return super.parseSubscript(e, s, i, r)
            ...
            return (
              ...
              (n.typeAnnotation = this.tsInType(
                () => (
                  this.next(),
                  this.match(75)
                    ? (r && this.raise(p.UnexpectedKeyword, { at: this.state.startLoc, keyword: 'const' }),
        ...
        checkImportReflection(e) {
          super.checkImportReflection(e),
            e.module &&
              e.importKind !== 'value' &&
              this.raise(x.ImportReflectionHasImportType, { at: e.specifiers[0].loc.start })
        }
        ...
        parseImport(e) {
          ...
          return (
            s.importKind === 'type' &&
              ...
              this.raise(x.TypeImportCannotSpecifyDefaultAndNamed, { at: s }),
            s
          )
        }
        parseExport(e, s) {
          ...
          for (let { id: o, init: h } of n.declarations)
            h &&
              (s !== 'const' || o.typeAnnotation
                ? this.raise(x.InitializerNotAllowedInAmbientContext, { at: h })
                : ar(h, this.hasPlugin('estree')) ||
                  this.raise(x.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, { at: h }))
          return n
        }
            ...
            this.tsIsStartOfStaticBlocks()
              ? (this.next(),
                ...
                this.tsHasSomeModifiers(s, r) &&
                  this.raise(x.StaticBlockCannotHaveModifier, { at: this.state.curPosition() }),
        ...
        parseClassMemberWithIsStatic(e, s, i, r) {
          ...
          if (n) {
            e.body.push(n),
              s.abstract && this.raise(x.IndexSignatureHasAbstract, { at: s }),
              s.accessibility && this.raise(x.IndexSignatureHasAccessibility, { at: s, modifier: s.accessibility }),
              s.declare && this.raise(x.IndexSignatureHasDeclare, { at: s }),
              s.override && this.raise(x.IndexSignatureHasOverride, { at: s })
            return
          }
          !this.state.inAbstractClass && s.abstract && this.raise(x.NonAbstractClassHasAbstractMethod, { at: s }),
            s.override && (i.hadSuperClass || this.raise(x.OverrideNotInSubClass, { at: s })),
            super.parseClassMemberWithIsStatic(e, s, i, r)
        }
        parsePostMemberNameModifiers(e) {
          this.eat(17) && (e.optional = !0),
            e.readonly && this.match(10) && this.raise(x.ClassMethodHasReadonly, { at: e }),
            e.declare && this.match(10) && this.raise(x.ClassMethodHasDeclare, { at: e })
        }
        parseExpressionStatement(e, s, i) {
          return (
        ...
        parseClassProperty(e) {
          if (
            ...
            this.state.isAmbientContext &&
              ...
              this.match(29) &&
              this.raise(x.DeclareClassFieldHasInitializer, { at: this.state.startLoc }),
        ...
        parseClassPrivateProperty(e) {
          return (
            e.abstract && this.raise(x.PrivateElementHasAbstract, { at: e }),
            e.accessibility && this.raise(x.PrivateElementHasAccessibility, { at: e, modifier: e.accessibility }),
            this.parseClassPropertyAnnotation(e),
        ...
        parseClassAccessorProperty(e) {
          return (
            this.parseClassPropertyAnnotation(e),
            e.optional && this.raise(x.AccessorCannotBeOptional, { at: e }),
        ...
        pushClassMethod(e, s, i, r, n, o) {
          ...
          l && (c === 'get' || c === 'set') && this.raise(x.DeclareAccessor, { at: s, kind: c }),
        ...
        parseMaybeAssign(e, s) {
          ...
          let f,
            d = this.tryParse((y) => {
              ...
              return (
                (E.type !== 'ArrowFunctionExpression' || ((I = E.extra) != null && I.parenthesized)) && y(),
                ((C = f) == null ? void 0 : C.params.length) !== 0 && this.resetStartLocationFromNode(E, f),
                (E.typeParameters = f),
                E
              )
            }, l)
        ...
        reportReservedArrowTypeParam(e) {
          ...
          e.params.length === 1 &&
            ...
            this.getPluginOption('typescript', 'disallowAmbiguousJSXLike') &&
            this.raise(x.ReservedArrowTypeParam, { at: e })
        }
        parseMaybeUnary(e, s) {
        ...
        toAssignable(e, s = !1) {
          switch (e.type) {
            ...
            case 'TSTypeAssertion':
              s
                ? this.expressionScope.recordArrowParameterBindingError(x.UnexpectedTypeCastInParameter, { at: e })
                : this.raise(x.UnexpectedTypeCastInParameter, { at: e }),
        ...
        parseMaybeDefault(e, s) {
          ...
          return (
            i.type === 'AssignmentPattern' &&
              i.typeAnnotation &&
              i.right.start < i.typeAnnotation.start &&
              this.raise(x.TypeAnnotationAfterAssign, { at: i.typeAnnotation }),
            i
          )
        }
        getTokenFromCode(e) {
        ...
        tsParseAbstractDeclaration(e, s) {
          ...
          if (this.isContextual(129)) {
            if (!this.hasFollowingLineBreak())
              return (
                (e.abstract = !0),
                this.raise(x.NonClassMethodPropertyHasAbstractModifer, { at: e }),
        ...
        parseTypeOnlyImportExportSpecifier(e, s, i) {
          ...
          if (this.isContextual(93)) {
            ...
            if (this.isContextual(93)) {
              ...
              M(this.state.type)
                ? ((l = !0), (o = d), (h = s ? this.parseIdentifier() : this.parseModuleExportName()), (c = !1))
                : ((h = y), (c = !1))
            } else
              M(this.state.type)
          ...
          l && i && this.raise(s ? x.TypeModifierIsUsedInTypeImports : x.TypeModifierIsUsedInTypeExports, { at: u }),
            (e[r] = o),
            (e[n] = h)
          let f = s ? 'importKind' : 'exportKind'
          ;(e[f] = l ? 'type' : 'value'),
            c && this.eatContextual(93) && (e[n] = s ? this.parseIdentifier() : this.parseModuleExportName()),
            e[n] || (e[n] = V(e[r])),
    ...
    function nr(a, t) {
      if (a.type === 'UnaryExpression') {
        ...
        if (e === '-' && hs(s, t)) return !0
      }
      return !1
    }
    function ls(a) {
      return a.type === 'Identifier' ? !0 : a.type !== 'MemberExpression' || a.computed ? !1 : ls(a.object)
    }
    var zt = $`placeholders`({
      ...
      or = (a) =>
        class extends a {
          ...
          parseClass(e, s, i) {
            ...
            return (
              super.parseClassSuper(e),
              (e.body = this.parsePlaceholder('ClassBody') || super.parseClassBody(!!e.superClass, n)),
              this.finishNode(e, r)
            )
          }
          parseExport(e, s) {
            ...
            let r = this.startNode()
            return (
              (r.exported = i), (e.specifiers = [this.finishNode(r, 'ExportDefaultSpecifier')]), super.parseExport(e, s)
            )
          }
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              ...
              if (
                ...
                this.input.startsWith(H(144), this.nextTokenStartSince(e + 4))
              )
                return !0
            }
          ...
          checkExport(e) {
            let { specifiers: s } = e
            s != null && s.length && (e.specifiers = s.filter((i) => i.exported.type === 'Placeholder')),
              super.checkExport(e),
              (e.specifiers = s)
          }
          parseImport(e) {
          ...
          assertNoSpace() {
            this.state.start > this.state.lastTokEndLoc.index &&
              this.raise(zt.UnexpectedSpace, { at: this.state.lastTokEndLoc })
          }
        },
      hr = (a) =>
        class extends a {
    ...
    var Kt = ['minimal', 'fsharp', 'hack', 'smart'],
      Ht = ['^^', '@@', '^', '%', '#'],
      Wt = ['hash', 'bar']
    function lr(a) {
      if (N(a, 'decorators')) {
      ...
      if (
        N(a, 'recordAndTuple') &&
        K(a, 'recordAndTuple', 'syntaxType') != null &&
        !Wt.includes(K(a, 'recordAndTuple', 'syntaxType'))
      )
        throw new Error(
          "The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Wt.map((t) => `'${t}'`).join(', ')
        )
    ...
    var cs = { estree: li, jsx: Yi, flow: Gi, typescript: ir, v8intrinsic: hr, placeholders: or },
      cr = Object.keys(cs),
      He = {
        sourceType: 'script',
    ...
    function pr(a) {
      if (a == null) return Object.assign({}, He)
    ...
    var ft = class extends ut {
          ...
          if ((e && (n = e.call(this, n, s)), di(this.state.type))) {
            ...
            if (((o.operator = h), this.match(29))) {
              ...
              t.doubleProtoLoc != null && t.doubleProtoLoc.index >= l && (t.doubleProtoLoc = null),
                t.shorthandAssignLoc != null && t.shorthandAssignLoc.index >= l && (t.shorthandAssignLoc = null),
        ...
        parseHackPipeBody() {
          ...
          return (
            ...
            this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, { at: e }),
            s
          )
        }
          ...
          if (Pi(this.state.type)) {
            ...
            if (
              ...
              l.type === 'Identifier'
                ...
                : this.hasPropertyAsPrivateName(l) && this.raise(p.DeletePrivateField, { at: n })
            }
        ...
        parseUpdate(t, e, s) {
          ...
          for (; xi(this.state.type) && !this.canInsertSemicolon(); ) {
            ...
            ;(n.operator = this.state.value),
              ...
              (n.argument = r),
              this.next(),
              this.checkLVal(r, { in: (r = this.finishNode(n, 'UpdateExpression')) })
          }
          return r
        }
        ...
        parseSubscript(t, e, s, i) {
          ...
          if (r === 18) {
            if (
              s &&
              (this.raise(p.OptionalChainingNoNew, { at: this.state.startLoc }), this.lookaheadCharCode() === 40)
            )
              return (i.stop = !0), t
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, i) {
          ...
          h && (this.expressionScope.enter(Vi()), (n = new ee())),
            l && (o.optional = i),
            i
              ? (o.arguments = this.parseCallExpressionArguments(11))
              : (o.arguments = this.parseCallExpressionArguments(11, t.type === 'Import', t.type !== 'Super', o, n))
          ...
          return (
            h && this.shouldParseAsyncArrow() && !i
              ...
              : (h && (this.checkExpressionErrors(n, !0), this.expressionScope.exit()), this.toReferencedArguments(c)),
        ...
        parseTaggedTemplateExpression(t, e, s) {
          ...
          return (
            ...
            s.optionalChainMember && this.raise(p.OptionalChainingNoTemplate, { at: e }),
        ...
        finishCallExpression(t, e) {
          if (t.callee.type === 'Import')
            if (
              (t.arguments.length === 2 && (this.hasPlugin('moduleAttributes') || this.expectImportAttributesPlugin()),
              ...
              for (let s of t.arguments) s.type === 'SpreadElement' && this.raise(p.ImportCallSpreadArgument, { at: s })
          ...
          for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(t); ) {
            if (o) o = !1
              ...
              e &&
                ...
                !this.hasPlugin('importAssertions') &&
                !this.hasPlugin('moduleAttributes') &&
                this.raise(p.ImportCallArgumentTrailingComma, { at: this.state.lastTokStartLoc }),
        ...
        parseAsyncArrowFromCallExpression(t, e) {
          ...
          return (
            ...
            e.innerComments && Pe(t, e.innerComments),
            e.callee.trailingComments && Pe(t, e.callee.trailingComments),
            t
          )
        }
        parseNoCallExpr() {
        ...
        parseExprAtom(t) {
          ...
          switch (i) {
              ...
              return (
                ...
                this.match(16)
                  ...
                  : this.match(10)
                    ...
                    : (this.raise(p.UnsupportedImport, { at: this.state.lastTokStartLoc }),
                      this.finishNode(e, 'Import'))
              )
            case 78:
            ...
            case 138:
              return (
                this.raise(p.PrivateInExpectedIn, { at: this.state.startLoc, identifierName: this.state.value }),
          ...
          if (this.testTopicReferenceConfiguration(s, e, i)) {
            ...
            return (
              this.topicReferenceIsAllowedInCurrentContext() ||
                this.raise(s === 'smart' ? p.PrimaryTopicNotAllowed : p.PipeTopicUnbound, { at: e }),
              this.registerTopicReference(),
              this.finishNode(t, r)
            )
          } else throw this.raise(p.PipeTopicUnconfiguredToken, { at: e, token: H(i) })
        }
        ...
        parseAsyncArrowUnaryFunction(t) {
          ...
          return (
            this.prodParam.exit(),
            this.hasPrecedingLineBreak() && this.raise(p.LineTerminatorBeforeArrow, { at: this.state.curPosition() }),
            this.expect(19),
        ...
        parseSuper() {
          ...
          return (
            ...
            !this.match(10) && !this.match(0) && !this.match(16) && this.raise(p.UnsupportedSuper, { at: t }),
        ...
        parseFunctionOrFunctionSent() {
          ...
          if ((this.next(), this.prodParam.hasYield && this.match(16))) {
            ...
            return (
              this.next(),
              this.match(103) ? this.expectPlugin('functionSent') : this.hasPlugin('functionSent') || this.unexpected(),
        ...
        parseMetaProperty(t, e, s) {
          ...
          return (
            ...
            (t.property.name !== s || i) &&
              this.raise(p.UnsupportedMetaProperty, { at: t.property, target: e.name, onlyValidPropertyName: s }),
        ...
        parseImportMetaProperty(t) {
          ...
          if ((this.next(), this.isContextual(101)))
            this.inModule || this.raise(p.ImportMetaOutsideModule, { at: e }), (this.sawUnambiguousESM = !0)
            ...
            if (
              ...
              throw this.raise(p.DynamicImportPhaseRequiresImportExpressions, {
                at: this.state.startLoc,
        ...
        parseParenAndDistinguishExpression(t) {
          ...
          for (; !this.match(11); ) {
            if (l) l = !1
              ...
              (this.expect(12, h.optionalParametersLoc === null ? null : h.optionalParametersLoc), this.match(11))
            ) {
            ...
            if (this.match(21)) {
              ...
              if (
                ...
                o.push(this.parseParenItem(this.parseRestBinding(), y)),
        ...
        parseNewCallee(t) {
          ...
          ;(t.callee = s),
            e &&
              ...
              this.raise(p.ImportCallNotNewExpression, { at: s })
        }
        parseTemplateElement(t) {
          ...
          r === null &&
            (t || this.raise(p.InvalidEscapeSequenceTemplate, { at: L(this.state.firstInvalidTemplateEscapePos, 1) }))
          let h = this.match(24),
            l = h ? -1 : -2,
            c = i + l
          ;(o.value = {
...
`
        ...
        parsePropertyDefinition(t) {
          ...
          if (this.match(26))
            for (
              this.hasPlugin('decorators') && this.raise(p.UnsupportedPropertyDecorator, { at: this.state.startLoc });
              this.match(26);
          ...
          if (!o && !h && this.maybeAsyncOrAccessorProp(s)) {
            ...
            c === 'async' &&
              !this.hasPrecedingLineBreak() &&
              ((i = !0), this.resetPreviousNodeTrailingComments(l), (o = this.eat(55)), this.parsePropertyName(s)),
              (c === 'get' || c === 'set') &&
                ((r = !0),
                this.resetPreviousNodeTrailingComments(l),
                (s.kind = c),
                this.match(55) &&
                  ((o = !0), this.raise(p.AccessorIsGenerator, { at: this.state.curPosition(), kind: c }), this.next()),
        ...
        checkGetterSetterParams(t) {
          ...
          i.length !== s && this.raise(t.kind === 'get' ? p.BadGetterArity : p.BadSetterArity, { at: t }),
            t.kind === 'set' &&
        ...
        parseObjectProperty(t, e, s, i) {
          if (((t.shorthand = !1), this.eat(14)))
            return (
              (t.value = s ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowIn(i)),
        ...
        parseExprListItem(t, e, s) {
          ...
          if (this.match(12))
            ...
            this.expectPlugin('partialApplication'),
              s || this.raise(p.UnexpectedArgumentPlaceholder, { at: this.state.startLoc })
            let r = this.startNode()
        ...
        parseAwait(t) {
          ...
          return (
            this.expressionScope.recordParameterInitializerError(p.AwaitExpressionFormalParameter, { at: e }),
        ...
        parseImportCall(t) {
          return (
            ...
            (this.hasPlugin('importAttributes') || this.hasPlugin('importAssertions')) && (t.options = null),
            this.eat(12) &&
              (this.expectImportAttributesPlugin(),
              this.match(11) || ((t.options = this.parseMaybeAssignAllowIn()), this.eat(12))),
            this.expect(11),
        ...
        checkSmartPipeTopicBodyEarlyErrors(t) {
          if (this.match(19)) throw this.raise(p.PipelineBodyNoArrow, { at: this.state.startLoc })
        ...
        if (typeof i == 'number') {
          {
            if (i === 138) {
              ...
              a.splice(
                e,
                1,
                new O({ type: _(27), value: '#', start: n, end: l, startLoc: r.start, endLoc: c }),
                new O({ type: _(132), value: o, start: l, end: h, startLoc: c, endLoc: r.end })
              ),
                e++
              continue
            }
            if (Oe(i)) {
              let { loc: r, start: n, value: o, end: h } = s,
                ...
                u
              t.charCodeAt(n) === 96
                ? (u = new O({ type: _(22), value: '`', start: n, end: l, startLoc: r.start, endLoc: c }))
                : (u = new O({ type: _(8), value: '}', start: n, end: l, startLoc: r.start, endLoc: c }))
              let f, d, y, I
              i === 24
                ? ((d = h - 1),
                  (y = L(r.end, -1)),
                  (f = o === null ? null : o.slice(1, -1)),
                  (I = new O({ type: _(22), value: '`', start: d, end: h, startLoc: y, endLoc: r.end })))
                : ((d = h - 2),
                  (y = L(r.end, -2)),
                  (f = o === null ? null : o.slice(1, -2)),
                  (I = new O({ type: _(23), value: '${', start: d, end: h, startLoc: y, endLoc: r.end }))),
                a.splice(e, 1, u, new O({ type: _(20), value: f, start: l, end: d, startLoc: c, endLoc: y }), I),
                (e += 2)
              continue
            }
          }
    ...
    var dt = class extends ft {
        parseTopLevel(t, e) {
          return (
            ...
            (t.comments = this.state.comments),
            this.options.tokens && (t.tokens = dr(this.tokens, this.input)),
        ...
        parseStatementContent(t, e) {
          ...
          switch (s) {
            ...
            case 107:
              ...
              return (
                ...
                !this.scope.inModule && this.scope.inTopLevel
                  ? this.raise(p.UnexpectedUsingDeclaration, { at: this.state.startLoc })
            ...
            case 100: {
              ...
              if (
                u !== 91 &&
                ((!r && this.hasFollowingLineBreak()) || (!this.chStartsBindingIdentifier(u, c) && u !== 123))
              )
                break
            }
            case 75:
              ...
              return (
                s === 83
                  ...
                  : ((c = this.parseExport(i, e)),
                    ((c.type === 'ExportNamedDeclaration' && (!c.exportKind || c.exportKind === 'value')) ||
                      (c.type === 'ExportAllDeclaration' && (!c.exportKind || c.exportKind === 'value')) ||
            ...
            default:
              if (this.isAsyncFunction())
                return (
                  r || this.raise(p.AsyncFunctionInSingleStatementContext, { at: this.state.startLoc }),
                  this.next(),
            ...
            t &&
              (e.decorators && e.decorators.length > 0
                ? (typeof this.getPluginOption('decorators', 'decoratorsBeforeExport') != 'boolean' &&
                    this.raise(p.DecoratorsBeforeAfterExport, { at: e.decorators[0] }),
        ...
        parseDecorators(t) {
          ...
          if (this.match(82))
            t || this.unexpected(),
              this.decoratorsEnabledBeforeExport() || this.raise(p.DecoratorExportClass, { at: this.state.startLoc })
        ...
        parseForStatement(t) {
          ...
          let s = this.isContextual(100)
          {
            ...
            if (this.match(74) || this.match(75) || c) {
              ...
              h
                ? ((f = 'await using'),
                  this.isAwaitAllowed() || this.raise(p.AwaitUsingNotInAsyncContext, { at: this.state.startLoc }),
                  this.next())
                : (f = this.state.value),
                this.next(),
                this.parseVar(u, !0, f)
              let d = this.finishNode(u, 'VariableDeclaration'),
                y = this.match(58)
              return (
                y && l && this.raise(p.ForInUsing, { at: d }),
                (y || this.isContextual(102)) && d.declarations.length === 1
          ...
          if (
            (o &&
              ...
              e === null && i && n.type === 'Identifier' && this.raise(p.ForOfAsync, { at: n })),
            o || this.match(58))
          ) {
        ...
        parseIfStatement(t) {
          return (
            ...
            (t.alternate = this.eat(66) ? this.parseStatementOrSloppyAnnexBFunctionDeclaration() : null),
            ...
            if (this.match(61) || this.match(65)) {
              ...
              s && this.finishNode(s, 'SwitchCase'),
                ...
                r
                  ...
                  : (i && this.raise(p.MultipleDefaultsInSwitch, { at: this.state.lastTokStartLoc }),
                    (i = !0),
                    (s.test = null)),
                this.expect(14)
        ...
        parseThrowStatement(t) {
          return (
            this.next(),
            this.hasPrecedingLineBreak() && this.raise(p.NewlineAfterThrow, { at: this.state.lastTokEndLoc }),
        ...
        parseTryStatement(t) {
          ...
          return (
            ...
            !t.handler && !t.finalizer && this.raise(p.NoCatchOrFinally, { at: t }),
        ...
        parseWithStatement(t) {
          return (
            this.state.strict && this.raise(p.StrictWith, { at: this.state.startLoc }),
            this.next(),
        ...
        parseLabeledStatement(t, e, s, i) {
          for (let n of this.state.labels) n.name === e && this.raise(p.LabelRedeclaration, { at: s, labelName: e })
          ...
          return (
            ...
            (t.body = i & 8 ? this.parseStatementOrSloppyAnnexBFunctionDeclaration(!0) : this.parseStatement()),
            this.state.labels.pop(),
            (t.label = s),
        ...
        parseForIn(t, e, s) {
          ...
          return (
            ...
            e.type === 'VariableDeclaration' &&
              ...
              this.raise(p.ForInOfLoopInitializer, { at: e, type: i ? 'ForInStatement' : 'ForOfStatement' }),
            e.type === 'AssignmentPattern' && this.raise(p.InvalidLhs, { at: e, ancestor: { type: 'ForStatement' } }),
            (t.left = e),
        ...
        parseVar(t, e, s, i = !1) {
          ...
          for (t.kind = s; ; ) {
            ...
            if (
              (this.parseVarId(n, s),
              (n.init = this.eat(29) ? (e ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn()) : null),
              n.init === null &&
                !i &&
                (n.id.type !== 'Identifier' && !(e && (this.match(58) || this.isContextual(102)))
                  ? this.raise(p.DeclarationMissingInitializer, { at: this.state.lastTokEndLoc, kind: 'destructuring' })
                  : s === 'const' &&
                    !(this.match(58) || this.isContextual(102)) &&
                    this.raise(p.DeclarationMissingInitializer, { at: this.state.lastTokEndLoc, kind: 'const' })),
        ...
        parseFunction(t, e = 0) {
          ...
          this.initFunction(t, n),
            this.match(55) &&
              (s && this.raise(p.GeneratorInSingleStatementContext, { at: this.state.startLoc }),
              this.next(),
              (t.generator = !0)),
        ...
        parseClassBody(t, e) {
          ...
          if (
            ...
            this.withSmartMixTopicForbiddingContext(() => {
              for (; !this.match(8); ) {
                if (this.eat(13)) {
                  if (i.length > 0) throw this.raise(p.DecoratorSemicolon, { at: this.state.lastTokEndLoc })
                  continue
                }
                if (this.match(26)) {
        ...
        parseClassMemberWithIsStatic(t, e, s, i) {
          ...
          if (((e.static = i), this.parsePropertyNamePrefixOperator(e), this.eat(55))) {
            ...
            this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsGenerator, { at: r.key }),
              this.pushClassMethod(t, r, !0, !1, !1, !1)
            return
          }
          let f = S(this.state.type) && !this.state.containsEsc,
            d = this.match(138),
            y = this.parseClassElementName(e),
          ...
          if ((this.parsePostMemberNameModifiers(u), this.isClassMethod())) {
            ...
            C &&
              ((r.kind = 'constructor'),
              s.hadConstructor && !this.hasPlugin('typescript') && this.raise(p.DuplicateConstructor, { at: y }),
              C && this.hasPlugin('typescript') && e.override && this.raise(p.OverrideOnConstructor, { at: y }),
              (s.hadConstructor = !0),
              (E = s.hadSuperClass)),
            ...
            this.parseClassElementName(c),
              ...
              E
                ...
                : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAsync, { at: r.key }),
            ...
            this.parseClassElementName(r),
              C
                ? this.pushClassPrivateMethod(t, n, !1, !1)
                : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAccessor, { at: r.key }),
        ...
        parseClassStaticBlock(t, e) {
          ...
          this.parseBlockOrModuleBlockBody(r, void 0, !1, 8),
            ...
            (s = e.decorators) != null && s.length && this.raise(p.DecoratorStaticBlock, { at: e })
        }
        ...
        parseExport(t, e) {
          let s = this.parseMaybeImportPhase(t, !0),
            ...
            l = i || n
          if (n && !o) {
            if ((i && this.unexpected(), e)) throw this.raise(p.UnsupportedDecoratorExport, { at: t })
          ...
          let u
          if (l || c) {
            if (((u = !1), e)) throw this.raise(p.UnsupportedDecoratorExport, { at: t })
          ...
          if (this.eat(65)) {
            let d = t,
              y = this.parseExportDefaultExpression()
        ...
        isExportDefaultSpecifier() {
          ...
          if (S(t)) {
            ...
            if ((t === 130 || t === 129) && !this.state.containsEsc) {
              ...
              if ((S(i) && i !== 98) || i === 5) return this.expectOnePlugin(['flow', 'typescript']), !1
            }
        ...
        shouldParseExportDeclaration() {
          let { type: t } = this.state
          return t === 26 && (this.expectOnePlugin(['decorators', 'decorators-legacy']), this.hasPlugin('decorators'))
            ? (this.getPluginOption('decorators', 'decoratorsBeforeExport') === !0 &&
                this.raise(p.DecoratorBeforeExport, { at: this.state.startLoc }),
              !0)
            : t === 74 || t === 75 || t === 68 || t === 80 || this.isLet() || this.isAsyncFunction()
        }
        checkExport(t, e, s, i) {
          if (e) {
            var r
            if (s) {
              ...
              for (let o of t.specifiers) {
                ...
                if ((this.checkDuplicateExports(o, l), !i && o.local)) {
                  let { local: c } = o
                  c.type !== 'Identifier'
                    ? this.raise(p.ExportBindingIsString, { at: o, localName: c.value, exportName: l })
              ...
              if (t.declaration.type === 'FunctionDeclaration' || t.declaration.type === 'ClassDeclaration') {
                ...
                for (let o of t.declaration.declarations) this.checkDeclaration(o.id)
            }
          }
        }
        checkDeclaration(t) {
        ...
        parseModuleExportName() {
          if (this.match(133)) {
            let t = this.parseStringLiteral(this.state.value),
              e = t.value.match(fr)
            return (
              e && this.raise(p.ModuleExportNameHasLoneSurrogate, { at: t, surrogateCharCode: e[0].charCodeAt(0) }), t
            )
          }
          return this.parseIdentifier(!0)
        }
        ...
        checkImportReflection(t) {
          ...
          if (t.phase === 'source')
            ...
            var i
            s !== 'ImportDefaultSpecifier' && this.raise(p.ImportReflectionNotBinding, { at: e[0].loc.start }),
              ((i = t.assertions) == null ? void 0 : i.length) > 0 &&
                this.raise(p.ImportReflectionHasAssertion, { at: t.specifiers[0].loc.start })
          }
        }
          ...
          if (this.isJSONModuleImport(t) && t.type !== 'ExportAllDeclaration') {
            ...
            if (e != null) {
              let s = e.find((i) => {
                let r
                if (
                  (i.type === 'ExportSpecifier' ? (r = i.local) : i.type === 'ImportSpecifier' && (r = i.imported),
                  r !== void 0)
                )
        ...
        parseMaybeImportPhase(t, e) {
          ...
          let s = this.parseIdentifier(!0),
            { type: i } = this.state
          return (M(i) ? i !== 98 || this.lookaheadCharCode() === 102 : i !== 12)
            ? (this.resetPreviousIdentifierLeadingComments(s), this.applyImportPhase(t, e, s.name, s.loc.start), null)
        ...
        parseImportAttributes() {
          ...
          do {
            ...
            let s = this.startNode(),
              i = this.state.value
            if (
              (e.has(i) && this.raise(p.ModuleAttributesWithDuplicateKeys, { at: this.state.startLoc, key: i }),
              e.add(i),
              this.match(133) ? (s.key = this.parseStringLiteral(i)) : (s.key = this.parseIdentifier(!0)),
              this.expect(14),
              !this.match(133))
            )
        ...
        parseModuleAttributes() {
          ...
          do {
            ...
            if (
              ...
              s.key.name !== 'type' && this.raise(p.ModuleAttributeDifferentFromType, { at: s.key }),
              e.has(s.key.name) && this.raise(p.ModuleAttributesWithDuplicateKeys, { at: s.key, key: s.key.name }),
              e.add(s.key.name),
              this.expect(14),
              !this.match(133))
            )
          ...
          if (this.match(76)) {
            ...
            this.next(),
              this.hasPlugin('moduleAttributes')
                ...
                : (this.expectImportAttributesPlugin(), (e = this.parseImportAttributes())),
              (s = !0)
          } else if (this.isContextual(94) && !this.hasPrecedingLineBreak())
            this.hasPlugin('importAttributes')
              ? (this.getPluginOption('importAttributes', 'deprecatedAssertSyntax') !== !0 &&
                  this.raise(p.ImportAttributesUseAssert, { at: this.state.startLoc }),
        ...
        parseNamedImportSpecifiers(t) {
          ...
          for (this.expect(5); !this.eat(8); ) {
            if (e) e = !1
              ...
              if (this.eat(14)) throw this.raise(p.DestructureNamedImport, { at: this.state.startLoc })
        ...
        parseImportSpecifier(t, e, s, i, r) {
          if (this.eatContextual(93)) t.local = this.parseIdentifier()
            ...
            let { imported: n } = t
            if (e) throw this.raise(p.ImportBindingIsString, { at: t, importName: n.value })
      ...
      Be = class extends dt {
        constructor(t, e) {
          ;(t = pr(t)),
            ...
            (this.plugins = mr(this.options.plugins)),
...
`
      ...
      let e = ''
      for (; e !== a; ) (e = a), (a = a.replace(vr, `${t}$1 $2${t}`))
      a = a.replace(Ps, '').trimRight()
      let s = Object.create(null),
        i = a.replace(gs, '').replace(Ps, '').trimRight(),
        r
      for (; (r = gs.exec(a)); ) {
...
` ||
  ...
  var ba = _e(/\s/),
    ...
    ms = _e(/[^\n\r]/)
  function Cr(a, t) {
    return t === !1 ? !1 : a.charAt(t) === '/' && a.charAt(t + 1) === '/' ? ms(a, t) : t
  }
  var ys = Cr
  function Er(a, t) {
    let e = null,
      s = t
    for (; s !== e; ) (e = s), (s = ds(a, s)), (s = us(a, s)), (s = ys(a, s)), (s = fs(a, s))
    return s
  }
  var xs = Er
  var re = qe(ws(), 1)
  function Br(a) {
    ...
    let e = (0, re.extract)(a),
      { pragmas: s, comments: i } = (0, re.parseWithComments)(e)
  ...
  function _r(a) {
    return (
      ...
      { astFormat: 'estree', hasPragma: Cs, locStart: D, locEnd: B, ...a }
    )
  }
  var ae = _r
  function Ur(a, t) {
  ...
  var Es = Vr
  var qr = Es(['Block', 'CommentBlock', 'MultiLine']),
    be = qr
  function zr(a) {
...
`)
  ...
  function Se(a) {
    ...
    return (Ae = Se.prototype = a ?? Object.create(null)), new Se()
  }
  var Hr = 10
  for (let a = 0; a <= Hr; a++) Se()
  function Nt(a) {
    return Se(a)
  }
  ...
  function kt(a, t) {
    ...
    if (Array.isArray(a)) {
      for (let s = 0; s < a.length; s++) a[s] = kt(a[s], t)
      return a
    }
    let e = vs(a)
    for (let s = 0; s < e.length; s++) a[e[s]] = kt(a[e[s]], t)
    return t(a) || a
  }
  var je = kt
  function Xr(a, t) {
    ...
    if (
          ...
          case 'ExportAllDeclaration':
            if (e === 'meriyah' && ((r = i.exported) == null ? void 0 : r.type) === 'Identifier') {
              ...
              ;(o.startsWith('"') || o.startsWith("'")) &&
                (i.exported = { ...i.exported, type: 'Literal', value: i.exported.name, raw: o })
            }
            break
          case 'TSUnionType':
      ...
      for (let r = a.comments.length - 2; r >= 0; r--) {
        ...
        B(n) === D(i) &&
          ...
          It(n) &&
          It(i) &&
          (a.comments.splice(r + 1, 1), (n.value += '*//*' + i.value), (n.range = [D(n), B(i)])),
          (i = n)
      }
    }
  ...
  var ne = (a) => ae(ia(a)),
    ...
    Zr = ['recordAndTuple', { syntaxType: 'hash' }],
    Os = 'v8intrinsic',
    Fs = [
    ...
    R = (a, t = Qr) => ({ ...t, plugins: [...t.plugins, ...a] }),
    ea = /@(?:no)?flow\b/
  function ta(a, t) {
    var i
  ...
  function sa(a, t, e) {
    let s = a(t, e),
      i = s.errors.find((r) => !ra.has(r.reasonCode))
    if (i) throw i
    return s
  }
  function ia({ isExpression: a = !1, optionsCombinations: t }) {
    return (e, s = {}) => {
      ...
      let i = t
      ;(s.__babelSourceType ?? Ms(s)) === 'script' && (i = i.map((l) => ({ ...l, sourceType: 'script' }))),
        /#[[{]/.test(e) && (i = i.map((l) => R([Zr], l)))
      let n = /%[A-Z]/.test(e)
      e.includes('|>')
        ? (i = (n ? [...Fs, Os] : Fs).flatMap((c) => i.map((u) => R([c], u))))
        : n && (i = i.map((l) => R([Os], l)))
      let o = a ? Ve.parseExpression : Ve.parse,
        h
      try {
  ...
  var ra = new Set([
    ...
    js = [R(['jsx'])],
    Bs = ne({ optionsCombinations: js }),
    Rs = ne({ optionsCombinations: [R(['jsx', 'typescript']), R(['typescript'])] }),
    _s = ne({ isExpression: !0, optionsCombinations: [R(['jsx'])] }),
    Us = ne({ isExpression: !0, optionsCombinations: [R(['typescript'])] }),
    $s = ne({ optionsCombinations: [R(['jsx', ['flow', { all: !0, enums: !0 }], 'flowComments'])] }),
    aa = ne({ optionsCombinations: js.map((a) => R(['estree'], a)) }),
    Vs = {
      babel: Bs,
      'babel-flow': $s,
      'babel-ts': Rs,
      ...
      __ts_expression: Us,
      __vue_expression: _s,
      __vue_ts_expression: Us,
      __vue_event_binding: Bs,
      __vue_ts_event_binding: Rs,
      __babel_estree: aa
    }
  var zs = qe(Ct(), 1)
  function Ks(a = {}) {
    ...
    return function (s) {
      let i
      try {
        i = (0, zs.parseExpression)(s, { tokens: !0, ranges: !0, attachComment: !1 })
      } catch (r) {
        throw (r == null ? void 0 : r.reasonCode) === 'MissingPlugin' ||
          (r == null ? void 0 : r.reasonCode) === 'MissingOneOfPlugins'
          ? Te({ message: 'Unexpected token', loc: r.loc })
          : Te(r)
      }
      if (!t && Y(i.comments)) throw W(i.comments[0], 'Comment')
  ...
  function oe(a) {
    switch (a.type) {
      case 'ArrayExpression':
        for (let t of a.elements) t !== null && oe(t)
        return
      case 'ObjectExpression':
        for (let t of a.properties) oe(t)
        return
      case 'ObjectProperty':
      ...
      case 'TemplateLiteral':
        if (Y(a.expressions)) throw W(a.expressions[0], "'TemplateLiteral' with expression")
        for (let t of a.quasis) oe(t)
        return
      case 'NullLiteral':
      case 'BooleanLiteral':
      case 'NumericLiteral':
  ...
  var qs = Ks(),
    na = {
      ...
      json5: ae(qs),
      'json-stringify': ae({ parse: Ks({ allowComments: !1 }), astFormat: 'estree-json' })
    },
    Hs = na
  var oa = { ...Vs, ...Hs }
  return Zs(ha)
