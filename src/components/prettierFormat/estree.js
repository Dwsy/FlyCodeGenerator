  ...
  var Ra = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    Ws = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let s of _a(t))
          !Ma.call(e, s) && s !== r && Cr(e, s, { get: () => t[s], enumerable: !(n = va(t, s)) || n.enumerable })
      return e
    }
  var Ja = (e, t, r) => (
      (r = e != null ? wa(ja(e)) : {}),
      Ws(t || !e || !e.__esModule ? Cr(r, 'default', { value: e, enumerable: !0 }) : r, e)
    ),
    qa = (e) => Ws(Cr({}, '__esModule', { value: !0 }), e)
  var Gs = (e, t, r) => {
    if (!t.has(e)) throw TypeError('Cannot ' + r)
  }
  var ut = (e, t, r) => (Gs(e, t, 'read from private field'), r ? r.call(e) : t.get(e)),
    Ys = (e, t, r) => {
...
`
      ...
      let n = Object.create(null),
        s = e.replace(ya, '').replace(Da, '').trimRight(),
        u
      for (; (u = ya.exec(e)); ) {
...
`,
  ...
  var zl = {}
  Ar(zl, { languages: () => Hl, options: () => Pa, printers: () => Kl })
  var js = {}
  Ar(js, {
    canAttachComment: () => gp,
    embed: () => ca,
  ...
  var ze = 'string',
    ...
    Le = 'label',
    Oe = 'break-parent',
    Tr = new Set([Qe, Je, qe, Ze, oe, Fe, de, Ue, We, Ge, pe, Le, Oe])
  function Wa(e) {
  ...
  var et = Wa
  var Ga = (e) => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(e)
  function Ya(e) {
...
Expected it to be ${n}.`
        ...
        switch (i) {
          ...
          case oe:
            if (n && u.expandedStates)
              for (let a = u.expandedStates.length, o = a - 1; o >= 0; --o) s.push(u.expandedStates[o])
  ...
  var Vs = () => {},
    ...
    dr = Vs
  function E(e) {
    return Ye(e), { type: Je, contents: e }
  }
  function xe(e, t) {
    return Ye(t), { type: qe, contents: t, n: e }
  }
  function m(e, t = {}) {
    return (
      Ye(e),
      dr(t.expandedStates, !0),
      { type: oe, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
    )
  }
  function Ks(e) {
  ...
  function Lt(e) {
    return dr(e), { type: Fe, parts: e }
  }
  function B(e, t = '', r = {}) {
    return Ye(e), t !== '' && Ye(t), { type: de, breakContents: e, flatContents: t, groupId: r.groupId }
  }
  function Et(e, t) {
    return Ye(e), { type: Ue, contents: e, groupId: t.groupId, negate: t.negate }
  }
  function On(e) {
    return Ye(e), { type: We, contents: e }
  }
  var Be = { type: Ge },
    le = { type: Oe }
  var wn = { type: pe, hard: !0 },
    Na = { type: pe, hard: !0, literal: !0 },
    T = { type: pe },
    F = { type: pe, soft: !0 },
    C = [wn, le],
    gr = [Na, le],
  ...
  function tt(e, t) {
    return Ye(t), e ? { type: Le, label: e, contents: t } : t
  }
  var $a = (e, t, r) => {
...
` ||
  ...
  var $e = so
  function uo(e, t, r = {}) {
    let n = Ne(e, r.backwards ? t - 1 : t, r),
      s = $e(e, n, r)
    return n !== s
  }
  var Q = uo
  ...
  function Co(e, t) {
    let r = e.slice(1, -1),
      n =
        t.parser === 'json' || (t.parser === 'json5' && t.quoteProps === 'preserve' && !t.singleQuote)
          ? '"'
  ...
  var q = Ao
  var To = q(['Block', 'CommentBlock', 'MultiLine']),
    Z = To
  function xo(e, t) {
    let r = t.split('.')
  ...
  var Lr = So
  function er(e, t) {
    return t(e) || nu(e, { getVisitorKeys: br, predicate: t })
  }
  function Mt(e) {
    return (
  ...
  var tr = q([
    ...
    G = q(['ArrayExpression', 'TupleExpression']),
    se = q(['ObjectExpression', 'RecordExpression'])
  function ke(e) {
  ...
  var rr = q([
    ...
    Au = q(['Identifier', 'ThisExpression', 'Super', 'PrivateName', 'PrivateIdentifier', 'Import']),
    we = q(['ObjectTypeAnnotation', 'TSTypeLiteral', 'TSMappedType']),
    jt = q(['FunctionExpression', 'ArrowFunctionExpression'])
  function Bo(e) {
    return e.type === 'FunctionExpression' || (e.type === 'ArrowFunctionExpression' && e.body.type === 'BlockStatement')
  }
  function jn(e) {
    return (
      I(e) && e.callee.type === 'Identifier' && ['async', 'inject', 'fakeAsync', 'waitForAsync'].includes(e.callee.name)
    )
  }
  var Y = q(['JSXElement', 'JSXFragment'])
  function Gn(e) {
  ...
  function Tu(e) {
    return (
      ...
      !e.static &&
      !Ft(e, e.typeAnnotation)
    )
  }
  var me = q(['BinaryExpression', 'LogicalExpression', 'NGPipeExpression'])
  function Ct(e) {
  ...
  function Rt(e) {
    return (
      ...
      Ir(e) ||
      bo(e) ||
      ((e.type === 'GenericTypeAnnotation' || e.type === 'TSTypeReference') && !e.typeParameters)
    )
  }
  function Po(e) {
  ...
  function gt(e, t) {
    ...
    if (e.arguments.length === 1) {
      ...
      return e.arguments[2] && !ke(e.arguments[2])
        ? !1
        : (e.arguments.length === 2 ? jt(e.arguments[1]) : Bo(e.arguments[1]) && V(e.arguments[1]).length <= 1) ||
            jn(e.arguments[1])
    return !1
  }
  var I = q(['CallExpression', 'OptionalCallExpression']),
    R = q(['MemberExpression', 'OptionalMemberExpression'])
  function du(e) {
    let t = 'expressions'
  ...
  function xu(e, { maxDepth: t = Number.POSITIVE_INFINITY } = {}) {
    if (A(e)) return !1
    if (e.type === 'ChainExpression') return xu(e.expression, { maxDepth: t })
    if (!R(e)) return !1
    let r = e,
      n = 0
  ...
  function nr(e, t) {
    ...
    if (A(e)) return !1
    let n = r * Lo
    if (e.type === 'ThisExpression' || (e.type === 'Identifier' && e.name.length <= n) || (Un(e) && !A(e.argument)))
      return !0
...
`)
  ...
  function Nn(e, t) {
    return (
      t.parser !== 'json' &&
      ee(e.key) &&
      De(e.key).slice(1, -1) === e.key.value &&
      ((tu(e.key.value) &&
        !(
...
`)
  ...
  function _r(e, t) {
    return (
      ((e.type === 'TemplateLiteral' && fu(e)) || (e.type === 'TaggedTemplateExpression' && fu(e.quasi))) &&
      !Q(t, J(e), { backwards: !0 })
    )
  }
  function jr(e) {
...
`)
    ...
    return R(e)
      ? Pe(e.object, t) && Pe(e.property, t)
      : (e.type === 'UnaryExpression' && Oo.has(e.operator)) || e.type === 'UpdateExpression'
        ? Pe(e.argument, t)
        : e.type === 'TSNonNullExpression'
          ? Pe(e.expression, t)
          : !1
  ...
  function Pu(e, t) {
    ...
    r.this && e.call(s, 'this'),
      Array.isArray(r.parameters) ? e.each(s, 'parameters') : Array.isArray(r.params) && e.each(s, 'params'),
  ...
  function ge(e) {
    ...
    return (
      e.type === 'ImportExpression' &&
        ((t = [e.source]), e.attributes && t.push(e.attributes), e.options && t.push(e.options)),
      Rn.set(e, t),
      t
    )
  }
  ...
  var ir = Symbol('ifWithoutBlockAndSameLineComment'),
    Ae = q(['TSAsExpression', 'TSSatisfiesExpression', 'AsExpression', 'AsConstExpression', 'SatisfiesExpression'])
  function Kn(e, t) {
    var u, i, a, o, p, D, y
    ...
    if (r.type === 'Identifier') {
      if (
        ((u = r.extra) != null && u.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(r.name)) ||
        (n === 'left' && ((r.name === 'async' && !s.await) || r.name === 'let') && s.type === 'ForOfStatement')
      )
        return !0
      if (r.name === 'let') {
      ...
      if (n === 'object' && r.name === 'let' && s.type === 'MemberExpression' && s.computed && !s.optional) {
        let c = e.findAncestor(
            (l) => l.type === 'ExpressionStatement' || l.type === 'ForStatement' || l.type === 'ForInStatement'
          ),
          f = c
    ...
    switch (s.type) {
      ...
      case 'ClassExpression':
        if (
          ...
          (r.type === 'ArrowFunctionExpression' ||
            ...
            (r.type === 'ClassExpression' && k(r.decorators)))
        )
          return !0
        break
      ...
      case 'Decorator':
        ...
        break
      case 'TypeAnnotation':
        if (e.match(void 0, void 0, (c, f) => f === 'returnType' && c.type === 'ArrowFunctionExpression') && jo(r))
          return !0
        break
      case 'BinaryExpression':
    ...
    switch (r.type) {
      case 'UpdateExpression':
        if (s.type === 'UnaryExpression')
          return (
            r.prefix && ((r.operator === '++' && s.operator === '+') || (r.operator === '--' && s.operator === '-'))
          )
        ...
        switch (s.type) {
          ...
          case 'BinaryExpression': {
            ...
            let l = Zt(c),
              h = s.operator,
              g = Zt(h)
            return g > l || (n === 'right' && g === l) || (g === l && !sr(h, c))
              ? !0
              : g < l && c === '%'
                ? h === '+' || h === '-'
                : !!Bu(h)
      ...
      case 'TSConstructorType':
        if (n === 'extendsType' && s.type === 'TSConditionalType') {
          ...
          if (
            (c.type === 'TSTypePredicate' && c.typeAnnotation && (c = c.typeAnnotation.typeAnnotation),
      ...
      case 'TSTypeQuery':
        return (
          (n === 'objectType' && s.type === 'TSIndexedAccessType') || (n === 'elementType' && s.type === 'TSArrayType')
        )
      case 'TypeofTypeAnnotation':
        return (
          (n === 'objectType' && (s.type === 'IndexedAccessType' || s.type === 'OptionalIndexedAccessType')) ||
      ...
      case 'FunctionTypeAnnotation': {
        ...
        return (
          ...
          (n === 'objectType' && (c.type === 'IndexedAccessType' || c.type === 'OptionalIndexedAccessType')) ||
      ...
      case 'ConditionalTypeAnnotation':
        if (
          (n === 'extendsType' && s.type === 'ConditionalTypeAnnotation' && r.type === 'ConditionalTypeAnnotation') ||
          (n === 'checkType' && s.type === 'ConditionalTypeAnnotation')
        )
          return !0
      ...
      case 'AssignmentExpression': {
        ...
        return n === 'body' && s.type === 'ArrowFunctionExpression'
          ? !0
          : (n === 'key' && (s.type === 'ClassProperty' || s.type === 'PropertyDefinition') && s.computed) ||
            ...
            : s.type === 'ExpressionStatement'
              ...
              : !(
                  ...
                  (s.type === 'SequenceExpression' && c.type === 'ForStatement' && (c.init === s || c.update === s)) ||
                  (n === 'value' && s.type === 'Property' && c.type === 'ObjectPattern' && c.properties.includes(s)) ||
      ...
      case 'BindExpression':
        return (
          (n === 'callee' && (s.type === 'BindExpression' || s.type === 'NewExpression')) || (n === 'object' && R(s))
        )
      case 'NGPipeExpression':
        return !(
          s.type === 'NGRoot' ||
          s.type === 'NGMicrosyntaxExpression' ||
          (s.type === 'ObjectProperty' && !((y = r.extra) != null && y.parenthesized)) ||
          G(s) ||
          (n === 'arguments' && I(s)) ||
  ...
  function Iu(e, t) {
    ...
    return r.type === 'FunctionExpression' || r.type === 'ClassExpression'
      ? n.type === 'ExportDefaultDeclaration' || !Kn(e, t)
      : !Mt(r) || (n.type !== 'ExportDefaultDeclaration' && Kn(e, t))
        ? !1
        : e.call(() => Iu(e, t), ...wr(r))
  }
  function Ro(e) {
    ...
    return !!(
      ((t.type === 'OptionalMemberExpression' || t.type === 'OptionalCallExpression') &&
        ((s === 'object' && r.type === 'MemberExpression') ||
          (s === 'callee' && (r.type === 'CallExpression' || r.type === 'NewExpression')) ||
      ...
      (e.match(
        ...
        (e.match(
          ...
          void 0,
          (u, i) =>
            (i === 'callee' && ((u.type === 'CallExpression' && !u.optional) || u.type === 'NewExpression')) ||
  ...
  function Jo(e, t) {
    let r = t - 1
    ;(r = Ne(e, r, { backwards: !0 })), (r = $e(e, r, { backwards: !0 })), (r = Ne(e, r, { backwards: !0 }))
    let n = $e(e, r, { backwards: !0 })
    return r !== n
  }
  var Lu = Jo
  var qo = () => !0
  ...
  function Uo(e, t) {
    ...
    if ((D = s.isBlockComment) == null ? void 0 : D.call(s, r)) {
      let y = Q(u, a(r)) ? (Q(u, i(r), { backwards: !0 }) ? C : T) : ' '
      n.push(y)
    } else n.push(C)
    let p = $e(u, Ne(u, a(r)))
  ...
  function Wo(e, t, r) {
    ...
    if ((r != null && r.hasLineSuffix && !(r != null && r.isBlock)) || Q(i, a(n), { backwards: !0 })) {
      let D = Lu(i, a(n))
      return { doc: On([C, D ? C : '', s]), isBlock: o, hasLineSuffix: !0 }
    }
    return !o || (r != null && r.hasLineSuffix)
      ? { doc: [On([' ', s]), le], isBlock: o, hasLineSuffix: !0 }
      : { doc: [' ', s], isBlock: o, hasLineSuffix: !1 }
  }
  function j(e, t, r = {}) {
    let { node: n } = e
    if (!k(n == null ? void 0 : n.comments)) return ''
    let { indent: s = !1, marker: u, filter: i = qo } = r,
      a = []
    if (
      (e.each(({ node: p }) => {
  ...
  var Ou = es
  var as = {}
  Ar(as, { endOfLine: () => Ko, ownLine: () => Vo, remaining: () => Ho })
  function Go(e, t) {
    let r = null,
      n = t
...
`
  ...
  var wu = $o
  function Vo(e) {
    return [Uu, _u, Ru, Qo, ns, ss, vu, ju, cp, op, is, qu, lp, Mu, Ju, us, Zo, Ap].some((t) => t(e))
  }
  function Ko(e) {
    return [zo, Ru, _u, qu, ns, ss, vu, ju, Ju, ap, pp, is, yp, us, Fp, Cp].some((t) => t(e))
  }
  function Ho(e) {
    return [Uu, ns, ss, ep, ip, Mu, is, up, sp, Ep, us, fp].some((t) => t(e))
  }
  function St(e, t) {
  ...
  function Zo({ comment: e, enclosingNode: t, followingNode: r, options: n }) {
    return !n.experimentalTernaries ||
      !(
        (t == null ? void 0 : t.type) === 'ConditionalExpression' ||
        (t == null ? void 0 : t.type) === 'ConditionalTypeAnnotation' ||
        (t == null ? void 0 : t.type) === 'TSConditionalType'
      )
      ? !1
      : (r == null ? void 0 : r.type) === 'ConditionalExpression' ||
          (r == null ? void 0 : r.type) === 'ConditionalTypeAnnotation' ||
  ...
  function _u({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s, options: u }) {
    ...
    return (!t || !i) &&
      ((r == null ? void 0 : r.type) === 'ConditionalExpression' ||
        ...
        (r == null ? void 0 : r.type) === 'TSConditionalType') &&
      n
      ? u.experimentalTernaries && r.alternate === n && !(Z(e) && !Ie(u.originalText, J(e), L(e)))
        ? (Te(r, e), !0)
        : (ae(n, e), !0)
      : !1
  }
    ...
    if (tp.has(r == null ? void 0 : r.type)) {
      ...
      if (n) {
        ...
        for (let s of ['implements', 'extends', 'mixins'])
          if (r[s] && n === r[s][0])
            return t && (t === r.id || t === r.typeParameters || t === r.superClass) ? te(t, e) : Te(r, e, s), !0
      }
    }
    return !1
  }
  ...
  function Mu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
    return r &&
      ...
      Ve(n, L(t)) !== ':'
      ? (te(t, e), !0)
      : (t == null ? void 0 : t.type) === 'Decorator' && rp.has(r == null ? void 0 : r.type)
        ? (te(t, e), !0)
        : !1
  }
  var np = new Set(['FunctionDeclaration', 'FunctionExpression', 'ClassMethod', 'MethodDefinition', 'ObjectMethod'])
  ...
  function ip({ comment: e, enclosingNode: t, text: r }) {
    return Ve(r, L(e)) !== ')'
      ? !1
      : t && ((Wu(t) && V(t).length === 0) || (pt(t) && ge(t).length === 0))
        ? (Te(t, e), !0)
  ...
  function op({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
    return (r == null ? void 0 : r.type) === 'UnionTypeAnnotation' || (r == null ? void 0 : r.type) === 'TSUnionType'
      ? (ur(e) && ((n.prettierIgnore = !0), (e.unignore = !0)), t ? (te(t, e), !0) : !1)
  ...
  function is({ comment: e, enclosingNode: t, followingNode: r, ast: n, isLastComment: s }) {
    ...
    return ((u = n == null ? void 0 : n.body) == null ? void 0 : u.length) === 0
      ? (s ? Te(n, e) : ae(n, e), !0)
      : (t == null ? void 0 : t.type) === 'Program' && t.body.length === 0 && !k(t.directives)
        ? (s ? Te(t, e) : ae(t, e), !0)
  ...
  function cp({ comment: e, enclosingNode: t }) {
    return (t == null ? void 0 : t.type) === 'ForInStatement' || (t == null ? void 0 : t.type) === 'ForOfStatement'
      ? (ae(t, e), !0)
      : !1
  }
  function qu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
    if ((r == null ? void 0 : r.type) === 'ImportSpecifier' || (r == null ? void 0 : r.type) === 'ExportSpecifier')
      return ae(r, e), !0
    let s =
        (t == null ? void 0 : t.type) === 'ImportSpecifier' && (r == null ? void 0 : r.type) === 'ImportDeclaration',
      u =
  ...
  var mp = new Set(['VariableDeclarator', 'AssignmentExpression', 'TypeAlias', 'TSTypeAliasDeclaration']),
    Dp = new Set([
      'ObjectExpression',
      'RecordExpression',
      'ArrayExpression',
  ...
  function Fp({ comment: e, enclosingNode: t, followingNode: r }) {
    return !t || t.type !== 'SwitchCase' || t.test || !r || r !== t.consequent[0]
      ? !1
      : (r.type === 'BlockStatement' && tr(e) ? St(r, e) : Te(t, e), !0)
  }
  function Cp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
    return t &&
      (t.type === 'TSUnionType' || t.type === 'UnionTypeAnnotation') &&
      (((r.type === 'TSArrayType' || r.type === 'ArrayTypeAnnotation') && n === void 0) ||
        r.type === 'TSIntersectionType' ||
        r.type === 'IntersectionTypeAnnotation')
      ? (te(w(!1, t.types, -1), e), !0)
      : !1
  }
  function Ap({ comment: e, enclosingNode: t, precedingNode: r, followingNode: n }) {
    if (
      ((t == null ? void 0 : t.type) === 'ObjectPattern' || (t == null ? void 0 : t.type) === 'ArrayPattern') &&
      (n == null ? void 0 : n.type) === 'TSTypeAnnotation'
    )
      return r ? te(r, e) : Te(t, e), !0
  }
  var Wu = q([
...
`)
  ...
  function Yu(e, t) {
    ...
    if (Z(r)) return Gu(r) ? dp(r) : ['/*', be(r.value), '*/']
...
`)
  ...
  var xp = new Set(['EmptyStatement', 'TemplateElement', 'Import', 'TSEmptyBodyFunctionExpression', 'ChainExpression'])
  function gp(e) {
      ...
      (Y(t) ||
        (r &&
          (r.type === 'JSXSpreadAttribute' ||
            ...
            r.type === 'TSUnionType' ||
            ((r.type === 'ClassDeclaration' || r.type === 'ClassExpression') && r.superClass === t)))) &&
      (!ht(t) || r.type === 'UnionTypeAnnotation' || r.type === 'TSUnionType')
    )
  }
...
\r	`),
  ...
  function Bp(e, t, r) {
    var v, M, _
    let { node: n } = e
    if (n.type === 'JSXElement' && qp(n)) return [r('openingElement'), r('closingElement')]
    ...
    n.children = n.children.map((d) => (Up(d) ? { type: 'JSXText', value: ' ', raw: ' ' } : d))
    let i = n.children.some(Y),
      a = n.children.filter((d) => d.type === 'JSXExpressionContainer').length > 1,
      o = n.type === 'JSXElement' && n.openingElement.attributes.length > 1,
      p = z(s) || i || o || a,
      D = e.parent.rootMarker === 'mdx',
      y = t.singleQuote ? "{' '}" : '{" "}',
      c = D ? ' ' : B([y, F], ' '),
      f = ((M = (v = n.openingElement) == null ? void 0 : v.name) == null ? void 0 : M.name) === 'fbt',
      l = bp(e, t, r, c, f),
      h = n.children.some((d) => or(d))
    for (let d = l.length - 2; d >= 0; d--) {
      let U = l[d] === '' && l[d + 1] === '',
        Ee = l[d] === C && l[d + 1] === '' && l[d + 2] === C,
        N = (l[d] === F || l[d] === C) && l[d + 1] === '' && l[d + 2] === c,
        ue = l[d] === c && l[d + 1] === '' && (l[d + 2] === F || l[d + 2] === C),
        H = l[d] === c && l[d + 1] === '' && l[d + 2] === c,
        It = (l[d] === F && l[d + 1] === '' && l[d + 2] === C) || (l[d] === C && l[d + 1] === '' && l[d + 2] === F)
    ...
    let S = h ? Lt(g) : m(g, { shouldBreak: !0 })
    if (
      (((_ = t.cursorNode) == null ? void 0 : _.type) === 'JSXText' &&
  ...
  function kp(e, t, r) {
    ...
    let s = e.match(
      ...
      u = he(e, r)
    return m([u ? '' : B('('), E([F, t]), F, u ? '' : B(')')], { shouldBreak: s })
  }
  function Ip(e, t, r) {
    let { node: n } = e,
      s = []
    if ((s.push(r('name')), n.value)) {
      ...
      if (ee(n.value)) {
        let i = De(n.value),
          a = K(!1, K(!1, i.slice(1, -1), '&apos;', "'"), '&quot;', '"'),
          o = kr(a, t.jsxSingleQuote)
        ;(a = o === '"' ? K(!1, a, '"', '&quot;') : K(!1, a, "'", '&apos;')),
          (u = e.call(() => ce(e, be(o + a + o), t), 'value'))
      } else u = r('value')
      s.push('=', u)
    }
    return s
      ...
      s = (u, i) =>
        ...
        (!A(u) &&
          (G(u) ||
            ...
            (u.type === 'AwaitExpression' && (s(u.argument, u) || u.argument.type === 'JSXElement')) ||
            I(u) ||
            (u.type === 'ChainExpression' && I(u.expression)) ||
            u.type === 'FunctionExpression' ||
            u.type === 'TemplateLiteral' ||
            u.type === 'TaggedTemplateExpression' ||
            u.type === 'DoExpression' ||
            (Y(i) && (u.type === 'ConditionalExpression' || me(u)))))
    return s(n.expression, e.parent)
      ? m(['{', r('expression'), Be, '}'])
      : m(['{', E([F, r('expression')]), F, Be, '}'])
  }
  function Op(e, t, r) {
    var a, o
    let { node: n } = e,
      s = A(n.name) || A(n.typeParameters) || A(n.typeArguments)
...
`)
  ...
  function wp(e, t, r) {
    return e.selfClosing ? [T, '/>'] : vp(e, t, r) ? ['>'] : [F, '>']
  }
  function vp(e, t, r) {
  ...
  function _p(e, t, r) {
    ...
    let u = r('name')
    return (
      A(n.name, x.Leading | x.Line)
        ? s.push(E([C, u]), C)
        : A(n.name, x.Leading | x.Block)
          ? s.push(' ', u)
          : s.push(u),
      s.push('>'),
      s
  ...
  function Jp(e, t, r) {
    ...
    return [
      ...
      e.call(
        ({ node: s }) => {
          let u = ['...', r()]
          return !A(s) || !os(e) ? u : [E([F, ce(e, u, t)]), F]
        },
  ...
  function or(e) {
    return e.type === 'JSXText' && (Jr.hasNonWhitespaceCharacter(De(e)) || !/\n/.test(De(e)))
  }
  function Up(e) {
  ...
  function Ur(e, t, r) {
    ...
    if (a) return p
    if (o) return m(p)
    if ((I(s) && s.callee === n) || s.type === 'UnaryExpression' || (R(s) && !s.computed)) return m([E([F, ...p]), F])
    let D =
        s.type === 'ReturnStatement' ||
        s.type === 'ThrowStatement' ||
        ...
        (n.type !== 'NGPipeExpression' &&
          ((s.type === 'NGRoot' && t.parser === '__ng_binding') ||
            (s.type === 'NGMicrosyntaxExpression' && u.type === 'NGMicrosyntax' && u.body.length === 1))) ||
        (n === s.body && s.type === 'ArrowFunctionExpression') ||
        (n !== s.body && s.type === 'ForStatement') ||
        (s.type === 'ConditionalExpression' && u.type !== 'ReturnStatement' && u.type !== 'ThrowStatement' && !I(u)) ||
      ...
      y =
        ...
        Ce(s),
      c = me(n.left) && sr(n.operator, n.left.operator)
    if (D || (Jt(n) && !c) || (!Jt(n) && y)) return m(p)
    if (p.length === 0) return ''
    let f = Y(n.right),
      l = p.findIndex((_) => typeof _ != 'string' && !Array.isArray(_) && _.type === oe),
      h = p.slice(0, l === -1 ? 1 : l + 1),
      g = p.slice(h.length, f ? -1 : void 0),
      S = Symbol('logicalChain-' + ++Gp),
      P = m([...h, E(g)], { id: S })
    if (!f) return P
    let v = w(!1, p, -1)
    return m([P, Et(v, { groupId: S })])
  }
  function cs(e, t, r, n, s) {
    ...
    let a = Jt(u),
      o = (u.operator === '|>' || u.type === 'NGPipeExpression' || Yp(e, r)) && !ve(r.originalText, u.right),
    ...
    if (a) y = [p, ' ', t('right'), D]
      ...
      let S =
        p === '|>' && ((h = e.root.extra) == null ? void 0 : h.__isUsingHackPipeline)
          ? e.call((P) => cs(P, t, r, !0, s), 'right')
          : t('right')
      y = [o ? T : '', p, o ? ' ' : T, S, D]
    }
    let { parent: c } = e,
      f = A(u.left, x.Trailing | x.Line),
      l =
        f ||
        (!(s && u.type === 'LogicalExpression') &&
          ...
          u.left.type !== u.type &&
          u.right.type !== u.type)
    if ((i.push(o ? '' : ' ', l ? m(y, { shouldBreak: f }) : y), n && A(u))) {
      let g = Ot(ce(e, i, r))
      return Array.isArray(g) || g.type === Fe ? hr(g) : [g]
    }
    return i
  }
  function Jt(e) {
    return e.type !== 'LogicalExpression'
      ? !1
      : !!((se(e.right) && e.right.properties.length > 0) || (G(e.right) && e.right.elements.length > 0) || Y(e.right))
  }
  ...
  function Yp(e, t) {
    return (
      ...
      Ku(e.node) &&
      !e.hasAncestor((r) => !Ku(r) && r.type !== 'JsExpressionRoot')
    )
  }
  ...
  function Xp(e, t, r, n) {
    let { node: s } = e
    return A(s, x.Dangling) ? m([r, j(e, t, { indent: !0 }), F, n]) : [r, n]
  }
  function qt(e, t, r) {
    let { node: n } = e,
      s = [],
    ...
    if (o.length === 0) s.push(Xp(e, t, u, i))
      ...
      let p = w(!1, o, -1),
        D = (p == null ? void 0 : p.type) !== 'RestElement',
        y = p === null,
        c = Symbol('array'),
        f =
          !t.__inJestEach &&
        ...
        l = ls(n, t),
        h = D ? (y ? ',' : ye(t) ? (l ? B(',', '', { groupId: c }) : B(',')) : '') : ''
      s.push(m([u, E([F, l ? $p(e, t, r, h) : [Np(e, t, a, r), h], j(e, t)]), F, i], { shouldBreak: f, id: c }))
    }
  ...
  function ls(e, t) {
    return (
      ...
      e.elements.every(
        (r) =>
          r &&
          (ke(r) || (Un(r) && !A(r.argument))) &&
          !A(r, x.Trailing | x.Line, (n) => !Q(t.originalText, J(n), { backwards: !0 }))
      )
    )
  }
  ...
  function Np(e, t, r, n) {
    ...
    return (
      e.each(({ node: u, isLast: i }) => {
        s.push(u ? m(n()) : ''), i || s.push([',', T, u && Hu(e, t) ? F : ''])
      }, r),
      s
    )
  }
  function $p(e, t, r, n) {
    ...
    return (
      e.each(({ isLast: u, next: i }) => {
        s.push([r(), u ? n : ',']), u || s.push(Hu(e, t) ? [C, C] : A(i, x.Leading | x.Line) ? C : T)
      }, 'elements'),
      Lt(s)
    )
  }
  function Vp(e, t, r) {
    ...
    if (zp(s)) return ['(', r(['arguments', 0]), ', ', r(['arguments', 1]), ')']
    let u = !1,
      i = s.length - 1,
      a = []
    Rr(e, ({ node: c }, f) => {
      let l = r()
      f === i || (fe(c, t) ? ((u = !0), (l = [l, ',', C, C])) : (l = [l, ',', T])), a.push(l)
    })
    let p = !(n.type === 'ImportExpression' || n.callee.type === 'Import') && ye(t, 'all') ? ',' : ''
    function D() {
      return m(['(', E([T, ...a]), p, T, ')'], { shouldBreak: !0 })
    }
    ...
    if (Hp(s)) {
      ...
      let f
      try {
        f = r(Vn(n, 0), { expandFirstArg: !0 })
      } catch (l) {
        if (l instanceof lt) return D()
        throw l
      }
      return z(f)
        ? [le, Xe([['(', m(f, { shouldBreak: !0 }), ', ', ...c, ')'], D()])]
        : Xe([['(', f, ', ', ...c, ')'], ['(', m(f, { shouldBreak: !0 }), ', ', ...c, ')'], D()])
    }
    if (Kp(s, a, t)) {
      let c = a.slice(0, -1)
      if (c.some(z)) return D()
      let f
      try {
        f = r(Vn(n, -1), { expandLastArg: !0 })
      } catch (l) {
        if (l instanceof lt) return D()
        throw l
      }
      return z(f)
        ? [le, Xe([['(', ...c, m(f, { shouldBreak: !0 }), ')'], D()])]
        : Xe([['(', ...c, f, ')'], ['(', ...c, m(f, { shouldBreak: !0 }), ')'], D()])
    }
    let y = ['(', E([F, ...a]), B(p), F, ')']
    return Mr(e) ? y : m(y, { shouldBreak: a.some(z) || u })
  }
  function pr(e, t = !1) {
    return (
      (se(e) && (e.properties.length > 0 || A(e))) ||
      (G(e) && (e.elements.length > 0 || A(e))) ||
      (e.type === 'TSTypeAssertion' && pr(e.expression)) ||
      (Ae(e) && pr(e.expression)) ||
      ...
      (e.type === 'ArrowFunctionExpression' &&
        ...
        (e.body.type === 'BlockStatement' ||
          (e.body.type === 'ArrowFunctionExpression' && pr(e.body, !0)) ||
          se(e.body) ||
          G(e.body) ||
          (!t && (I(e.body) || e.body.type === 'ConditionalExpression')) ||
          Y(e.body))) ||
      e.type === 'DoExpression' ||
  ...
  function Hp(e) {
    ...
    let [t, r] = e
    return t.type === 'ModuleExpression' && Zp(r)
      ? !0
      : !A(t) &&
  ...
  function Qu(e, t, r) {
    ...
    let n = r('object'),
      s = ms(e, t, r),
      { node: u, parent: i } = e,
      a = e.findAncestor((D) => !(R(D) || D.type === 'TSNonNullExpression')),
      o =
        (a &&
          (a.type === 'NewExpression' ||
            a.type === 'BindExpression' ||
            (a.type === 'AssignmentExpression' && a.left.type !== 'Identifier'))) ||
        u.computed ||
        (u.object.type === 'Identifier' && u.property.type === 'Identifier' && !R(i)) ||
        ((i.type === 'AssignmentExpression' || i.type === 'VariableDeclarator') &&
          ((I(u.object) && u.object.arguments.length > 0) ||
            (u.object.type === 'TSNonNullExpression' &&
              I(u.object.expression) &&
              u.object.expression.arguments.length > 0) ||
            ((p = n.label) == null ? void 0 : p.memberChain)))
    return tt(n.label, [n, o ? s : m(E([F, s]))])
  }
  function ms(e, t, r) {
    let n = r('property'),
      { node: s } = e,
  ...
  function ec(e, t, r) {
    ...
    function a(O) {
      let { node: W } = O
      I(W) && (Ct(W.callee) || I(W.callee))
        ? (u.unshift({ node: W, printed: [ce(O, [$(O), Ke(O, t, r), cr(O, t, r)], t), i(W) ? C : ''] }),
          O.call((ne) => a(ne), 'callee'))
        : Ct(W)
          ? (u.unshift({ node: W, needsParens: he(O, t), printed: ce(O, R(W) ? ms(O, t, r) : Wr(O, t, r), t) }),
            O.call((ne) => a(ne), 'object'))
          : W.type === 'TSNonNullExpression'
            ? (u.unshift({ node: W, printed: ce(O, '!', t) }), O.call((ne) => a(ne), 'expression'))
            : u.unshift({ node: W, printed: r() })
    }
    let { node: o } = e
    u.unshift({ node: o, printed: [$(e), Ke(e, t, r), cr(e, t, r)] }), o.callee && e.call((O) => a(O), 'callee')
    let p = [],
      D = [u[0]],
      y = 1
    for (
      ;
      y < u.length &&
      (u[y].node.type === 'TSNonNullExpression' ||
        I(u[y].node) ||
        (R(u[y].node) && u[y].node.computed && ke(u[y].node.property)));
      ++y
    )
      D.push(u[y])
    ...
    for (; y < u.length; ++y) {
      ...
      ;(I(u[y].node) || u[y].node.type === 'ImportExpression') && (c = !0),
        D.push(u[y]),
        A(u[y].node, x.Trailing) && (p.push(D), (D = []), (c = !1))
    }
    D.length > 0 && p.push(D)
    function f(O) {
      return /^[A-Z]|^[$_]+$/.test(O)
    ...
    function S(O) {
      ...
      return O.length > 0 && w(!1, O, -1).needsParens ? ['(', ...W, ')'] : W
    }
    function P(O) {
      return O.length === 0 ? '' : E(m([C, b(C, O.map(S))]))
    }
    let v = p.map(S),
      M = v,
      _ = g ? 3 : 2,
      d = p.flat(),
      U =
        d.slice(1, -1).some((O) => A(O.node, x.Leading)) ||
        d.slice(0, -1).some((O) => A(O.node, x.Trailing)) ||
        (p[_] && A(p[_][0].node, x.Leading))
    if (p.length <= _ && !U) return Mr(e) ? M : m(M)
    let Ee = w(!1, p[g ? 1 : 0], -1).node,
      N = !I(Ee) && i(Ee),
      ue = [S(p[0]), g ? p.slice(1, 2).map(S) : '', N ? C : '', P(p.slice(g ? 2 : 1))],
      H = u.map(({ node: O }) => O).filter(I)
    function It() {
      let O = w(!1, w(!1, p, -1), -1).node,
        W = w(!1, v, -1)
      return I(O) && z(W) && H.slice(0, -1).some((ne) => ne.arguments.some(jt))
    }
    let Nt
    return (
      U || (H.length > 2 && H.some((O) => !O.arguments.every((W) => Pe(W)))) || v.slice(0, -1).some(z) || It()
        ? (Nt = m(ue))
        : (Nt = [z(M) || N ? le : '', Xe([M, ue])]),
      tt({ memberChain: !0 }, Nt)
    )
  ...
  function Gr(e, t, r) {
    ...
    let { node: n, parent: s } = e,
      ...
      a = $(e),
      o = ge(n),
      p = o.length === 1 && _r(o[0], t.originalText)
    if (p || (o.length > 0 && !u && !i && (rc(n, s) || gt(n, s)))) {
      ...
      if (
        ...
        !(p && (y = c[0].label) != null && y.embed))
      )
        return [u ? 'new ' : '', r('callee'), a, Ke(e, t, r), '(', b(', ', c), ')']
    }
    if (!i && !u && Ct(n.callee) && !e.call((c) => he(c, t), 'callee')) return Zu(e, t, r)
    let D = [u ? 'new ' : '', i ? tc(n) : r('callee'), a, Ke(e, t, r), cr(e, t, r)]
  ...
  function At(e, t, r, n, s, u) {
    ...
    switch (i) {
      case 'break-after-operator':
        return m([m(n), s, m(E([T, a]))])
      case 'never-break-after-operator':
        return m([m(n), s, ' ', a])
      case 'fluid': {
        let o = Symbol('assignment')
        return m([m(n), s, m(E(T), { id: o }), Be, Et(a, { groupId: o })])
      }
      case 'break-lhs':
        return m([n, s, ' ', m(a)])
      case 'chain':
  ...
  function ti(e, t, r) {
    let { node: n } = e
    return At(e, t, r, r('left'), [' ', n.operator], 'right')
  }
  function ri(e, t, r) {
  ...
  function nc(e, t, r, n, s) {
    ...
    let a = !Yr(i)
    if (e.match(Yr, ni, (c) => !a || (c.type !== 'ExpressionStatement' && c.type !== 'VariableDeclaration')))
      return a
        ? i.type === 'ArrowFunctionExpression' && i.body.type === 'ArrowFunctionExpression'
          ? 'chain-tail-arrow-chain'
          : 'chain-tail'
        : 'chain'
    if ((!a && Yr(i.right)) || ve(t.originalText, i)) return 'break-after-operator'
    if ((i.type === 'CallExpression' && i.callee.name === 'require') || t.parser === 'json5' || t.parser === 'json')
      return 'never-break-after-operator'
    let D = eu(n)
    if (uc(u) || ic(u) || pc(u) || (Ds(u) && D)) return 'break-lhs'
    let y = lc(u, n, t)
    return e.call(() => sc(e, t, r, y), s)
  ...
  function ni(e) {
    return Yr(e) || e.type === 'VariableDeclarator'
  }
  function ic(e) {
    let t = oc(e)
    if (k(t)) {
  ...
  var ac = q(['TSTypeAliasDeclaration', 'TypeAlias'])
  function oc(e) {
    var t
  ...
  var cc = q(['TSTypeReference', 'GenericTypeAnnotation'])
  function ei(e) {
    var t
  ...
  function si(e, t, r, n = !1) {
    ...
    if (I(s)) {
      if ((i = Gr(e, t, r).label) != null && i.memberChain) return !1
      let o = ge(s)
  ...
  function mt(e, t, r, n, s) {
    let u = e.node,
      i = V(u),
      a = s ? Ke(e, r, t) : ''
    if (i.length === 0) return [a, '(', j(e, r, { filter: (l) => Ve(r.originalText, L(l)) === ')' }), ')']
    let { parent: o } = e,
      p = gt(o),
      D = ys(u),
      y = []
    if (
      (Pu(e, (l, h) => {
        ...
        g && u.rest && y.push('...'),
          y.push(t()),
          !g && (y.push(','), p || D ? y.push(' ') : fe(i[h], r) ? y.push(C, C) : y.push(T))
      }),
      n && !fc(e))
    ) {
    ...
    return D && c
      ...
      : p
        ...
        : (vr(o) ||
            ...
            Rt(i[0].typeAnnotation) &&
            !u.rest
          ? r.arrowParens === 'always'
            ? ['(', ...y, ')']
            : y
          : [a, '(', E([F, ...y]), B(!bu(u) && ye(r, 'all') ? ',' : ''), F, ')']
  }
  function ys(e) {
    if (!e) return !1
    let t = V(e)
    ...
    return (
      ...
      (r.type === 'ObjectPattern' ||
        ...
        (r.type === 'Identifier' &&
          ...
          we(r.typeAnnotation.typeAnnotation)) ||
        (r.type === 'FunctionTypeParam' && we(r.typeAnnotation) && r !== e.rest) ||
  ...
  function ii(e, t, r) {
    let n = t.semi ? ';' : '',
      { node: s } = e,
      u = [re(e), 'opaque type ', r('id'), r('typeParameters')]
  ...
  function $r(e, t, r) {
    let { node: n } = e,
      ...
      u =
        ...
        (s.type !== 'TSConditionalType' || !t.experimentalTernaries) &&
        (s.type !== 'ConditionalTypeAnnotation' || !t.experimentalTernaries) &&
        ...
        !(
          (s.type === 'TypeAlias' || s.type === 'VariableDeclarator' || s.type === 'TSTypeAliasDeclaration') &&
          ve(t.originalText, n)
        ),
      i = fs(n),
      a = e.map((D) => {
  ...
  function Vr(e, t, r) {
    ...
    return (
      n.type === 'FunctionTypeAnnotation'
        ? i.push(Ec(e) ? ' => ' : ': ', r('returnType'))
        : i.push(X(e, r, n.returnType ? 'returnType' : 'typeAnnotation')),
      Bt(n, i) && (u = m(u)),
      s.push(u, i),
      m(s)
    )
  ...
  function Es(e, t, r) {
    let { node: n } = e
    return [n.postfix ? '' : r, X(e, t), n.postfix ? r : '']
  }
  function zr(e, t, r) {
    let { node: n } = e
  ...
  var ai = (e) =>
    e.match(
      ...
      : e.match(
            ...
            (t, r) =>
              r === 'typeAnnotation' &&
              (t.type === 'TSJSDocNullableType' || t.type === 'TSJSDocNonNullableType' || t.type === 'TSTypePredicate')
          ) ||
          e.match(
  ...
  function tn({ node: e }, t) {
    let r = e.type === 'TSTypeQuery' ? 'exprName' : 'argument',
      n = e.type === 'TSTypeQuery' ? 'typeParameters' : 'typeArguments'
    return ['typeof ', t(r), t(n)]
  }
  function rn(e, t) {
    let { node: r } = e
    return [r.asserts ? 'asserts ' : '', t('parameterName'), r.typeAnnotation ? [' is ', X(e, t)] : '']
  }
  function $(e) {
    let { node: t } = e
    return !t.optional || (t.type === 'Identifier' && t === e.parent.key)
      ? ''
      : I(t) || (R(t) && t.computed) || t.type === 'OptionalIndexedAccessType'
        ? '?.'
        : '?'
  }
  function nn(e) {
  ...
  var Ac = new Set(['TSAbstractMethodDefinition', 'TSAbstractPropertyDefinition', 'TSAbstractAccessorProperty'])
  function Ut({ node: e }) {
  ...
  function Dt(e, t, r) {
    return e.type === 'EmptyStatement' ? ';' : e.type === 'BlockStatement' || r ? [' ', t] : E([T, t])
  }
  function sn(e, t) {
    return ['...', t('argument'), X(e, t)]
  }
  function Wt(e) {
    return e.accessibility ? e.accessibility + ' ' : ''
  }
  var oi = new Proxy(() => {}, { get: () => oi }),
    un = oi
  function Fs(e, t, r) {
    let { node: n } = e
    return m([b(T, e.map(r, 'decorators')), li(n, t) ? C : T])
  }
  function pi(e, t, r) {
    return mi(e.node) ? [b(C, e.map(r, 'declaration', 'decorators')), C] : ''
  }
  function ci(e, t, r) {
    let { node: n, parent: s } = e,
      { decorators: u } = n
    if (!k(u) || mi(s) || qr(e)) return ''
    let i = n.type === 'ClassExpression' || n.type === 'ClassDeclaration' || li(n, t)
    return [e.key === 'declaration' && Cu(s) ? C : i ? le : '', b(T, e.map(r, 'decorators')), T]
  }
  function li(e, t) {
  ...
  function an(e, t, r) {
    let { node: n } = e,
      s = [pi(e, t, r), re(e), 'export', yi(n) ? ' default' : ''],
      { declaration: u, exported: i } = n
    return (
      A(n, x.Dangling) && (s.push(' ', j(e, t)), jr(n) && s.push(C)),
      u
  ...
  function Ei(e, t, r) {
    ...
    if (k(n.specifiers)) {
      ...
      e.each(() => {
        ...
        i.length > 0 &&
          (u.length > 0 && s.push(', '),
          i.length > 1 || u.length > 0 || n.specifiers.some((o) => A(o))
            ? s.push(
                m([
                  '{',
                  E([t.bracketSpacing ? T : F, b([',', T], i)]),
                  B(ye(t) ? ',' : ''),
  ...
  function Fi(e, t) {
    return e.type !== 'ImportDeclaration' || k(e.specifiers) || e.importKind === 'type'
      ? !0
      : Ts(t, J(e), J(e.source)).trimEnd().endsWith('from')
  }
  function gc(e, t) {
  ...
  function hc(e, t) {
    var n, s
    return ((n = e.extra) != null && n.deprecatedAssertSyntax) ||
      Ts(t, L(e.source), (s = e.attributes) != null && s[0] ? J(e.attributes[0]) : L(e))
        .trimStart()
        .startsWith('assert')
      ? 'assert'
      : 'with'
  ...
  function Ci(e, t, r) {
    ...
    return (
      k(n.attributes) &&
        (t.bracketSpacing && u.push(' '), u.push(b(', ', e.map(r, 'attributes'))), t.bracketSpacing && u.push(' ')),
      u.push('}'),
      u
    )
  }
  function Ai(e, t, r) {
    let { node: n } = e,
      ...
      y = ''
    return (
      s === 'ExportNamespaceSpecifier' || s === 'ImportNamespaceSpecifier' ? (D = '*') : o && (D = r(i)),
      p && !Sc(n) && (y = r(a)),
      [Cs(s === 'ImportSpecifier' ? n.importKind : n.exportKind, !1), D, D && y ? ' as ' : '', y]
    )
  }
  function Sc(e) {
  ...
  function Ti(e, t, r) {
    let { node: n } = e,
      ...
      y = !1,
      { parent: c } = e,
      f = c.type === n.type && a.some((N) => c[N] === n),
      l = c.type === n.type && !f,
      h,
      g,
      S = 0
    ...
    if (s && (Y(n[a[0]]) || Y(o) || Y(p) || Bc(v))) {
      ...
      let N = (H) => [B('('), E([F, H]), F, B(')')],
        ue = (H) =>
          H.type === 'NullLiteral' ||
          (H.type === 'Literal' && H.value === null) ||
          (H.type === 'Identifier' && H.name === 'undefined')
      D.push(' ? ', ue(o) ? r(u) : N(r(u)), ' : ', p.type === n.type || ue(p) ? r(i) : N(r(i)))
    } else {
      let N = (H) => (t.useTabs ? E(r(H)) : xe(2, r(H))),
        ue = [T, '? ', o.type === n.type ? B('', '(') : '', N(u), o.type === n.type ? B('', ')') : '', T, ': ', N(i)]
      D.push(c.type !== n.type || c[i] === n || f ? ue : t.useTabs ? xr(E(ue)) : xe(Math.max(0, t.tabWidth - 2), ue))
    }
    let M = [u, i, ...a].some((N) => A(n[N], (ue) => Z(ue) && Ie(t.originalText, J(ue), L(ue)))),
      _ = (N) => (c === P ? m(N, { shouldBreak: M }) : M ? [N, le] : N),
      d = !y && (R(c) || (c.type === 'NGPipeExpression' && c.left === n)) && !c.computed,
      U = kc(e),
      Ee = _([bc(e, t, r), l ? D : E(D), s && d && !U ? F : ''])
    return f || U ? m([E([F, Ee]), F]) : Ee
  }
  function Ic(e, t) {
    return (R(t) || (t.type === 'NGPipeExpression' && t.left === e)) && !t.computed
  }
  function Lc(e, t, r, n) {
    return [...e.map((u) => ot(u)), ot(t), ot(r)].flat().some((u) => Z(u) && Ie(n.originalText, J(u), L(u)))
  }
  var Oc = new Map([
    ['AssignmentExpression', 'right'],
    ['VariableDeclarator', 'init'],
  ...
  function Gt(e, t, r, n) {
    ...
    let Ee = _ || f,
      N =
        ...
        (f.type === 'AssignmentExpression' ||
          ...
          f.type === 'ClassProperty' ||
          f.type === 'PropertyDefinition' ||
          f.type === 'ClassPrivateProperty' ||
          f.type === 'ObjectProperty' ||
          f.type === 'Property'),
      ue = (f.type === 'ReturnStatement' || f.type === 'ThrowStatement') && !(S || P),
      H = u && Ee.type === 'JSXExpressionContainer' && e.grandparent.type !== 'JSXAttribute',
      It = wc(e),
      Nt = Ic(s, f),
      O = i && he(e, t),
      W = M ? (t.useTabs ? '	' : ' '.repeat(t.tabWidth - 1)) : '',
      ne = Lc(c, D, y, t) || S || P,
      st =
        !v &&
        !l &&
        !i &&
        (H ? D.type === 'NullLiteral' || (D.type === 'Literal' && D.value === null) : nr(D, t) && Xn(s.test, 3)),
      xt = v || g || (i && !l) || (l && u && Xn(s.test, 1)) || st,
      Rs = []
    !S &&
      A(D, x.Dangling) &&
      e.call((Me) => {
    ...
    A(s.test, x.Dangling) &&
      ...
      A(s, x.Dangling) && $t.push(j(e, t))
    let Js = Symbol('test'),
      ka = Symbol('consequent'),
      Er = Symbol('test-and-consequent'),
      Ia = u
        ? [ds(r('test')), s.test.type === 'ConditionalExpression' ? le : '']
        : [
            r('checkType'),
            ' ',
            'extends',
            ' ',
            s.extendsType.type === 'TSConditionalType' ||
            s.extendsType.type === 'ConditionalTypeAnnotation' ||
            s.extendsType.type === 'TSMappedType'
              ? r('extendsType')
              : m(ds(r('extendsType')))
          ],
      qs = m([Ia, ' ?'], { id: Js }),
      La = r(a),
      Fr = E([S || (H && (Y(D) || l || v)) ? C : T, Rs, La]),
      Oa = xt ? m([qs, v ? Fr : B(Fr, m(Fr, { id: ka }), { groupId: Js })], { id: Er }) : [qs, Fr],
      kn = r(o),
      Us = st ? B(kn, xr(ds(kn)), { groupId: Er }) : kn,
      Vt = [
        Oa,
        $t.length > 0 ? [E([C, $t]), C] : P ? C : st ? B(T, ' ', { groupId: Er }) : T,
        ':',
        P ? ' ' : M ? (xt ? B(W, B(v || st ? ' ' : W, ' '), { groupId: Er }) : B(W, ' ')) : ' ',
        P ? Us : m([E(Us), H && !st ? F : '']),
        Nt && !It ? F : '',
        ne ? le : ''
      ]
    ...
    return t === Number.NEGATIVE_INFINITY
      ...
      : t < 0
        ...
        : t
          ? t.type === 'root'
            ? { ...e, root: e }
            : xs(e, { type: typeof t == 'string' ? 'stringAlign' : 'numberAlign', n: t }, r)
          : e
  }
  function xs(e, t, r) {
  ...
  function on(e, t, r, n, s, u) {
    ...
    for (; r >= 0; ) {
      ...
      switch (et(D)) {
        ...
        case Fe: {
          let y = hr(D)
          for (let c = y.length - 1; c >= 0; c--) a.push({ mode: p, doc: y[c] })
          break
        }
        case Je:
        case qe:
        ...
        case oe: {
          ...
          let y = D.break ? Se : p,
            c = D.expandedStates && y === Se ? w(!1, D.expandedStates, -1) : D.contents
          a.push({ mode: y, doc: c })
          break
        }
        case de: {
...
`,
        ...
        case Re:
          for (let h = l.length - 1; h >= 0; h--) i.push({ ind: c, mode: f, doc: l[h] })
          break
        case Qe:
          ...
          break
        case Je:
          i.push({ ind: jc(c, t), mode: f, doc: l.contents })
          break
        case qe:
          i.push({ ind: Mc(c, l.n, t), mode: f, doc: l.contents })
          break
        case Ze:
          u -= gs(a)
          break
        case oe:
          switch (f) {
            case nt:
              if (!o) {
                i.push({ ind: c, mode: l.break ? Se : nt, doc: l.contents })
                break
              }
            case Se: {
              o = !1
              let h = { ind: c, mode: nt, doc: l.contents },
                g = n - u,
                S = p.length > 0
              if (!l.break && on(h, i, g, S, r)) i.push(h)
              else if (l.expandedStates) {
                let P = w(!1, l.expandedStates, -1)
                if (l.break) {
                  i.push({ ind: c, mode: Se, doc: P })
                  break
                } else
                  for (let v = 1; v < l.expandedStates.length + 1; v++)
                    if (v >= l.expandedStates.length) {
                      ...
                      let M = l.expandedStates[v],
                        _ = { ind: c, mode: nt, doc: M }
                      if (on(_, i, g, S, r)) {
                        i.push(_)
                        break
                      }
                    }
              } else i.push({ ind: c, mode: Se, doc: l.contents })
              break
            }
          }
        ...
        case Fe: {
          ...
          let [S, P] = g,
            ...
            M = { ind: c, mode: Se, doc: S },
            _ = on(v, [], h, p.length > 0, r, !0)
          if (g.length === 1) {
            _ ? i.push(v) : i.push(M)
            break
          }
          let d = { ind: c, mode: nt, doc: P },
            U = { ind: c, mode: Se, doc: P }
          if (g.length === 2) {
            _ ? i.push(d, v) : i.push(U, M)
            break
          }
          g.splice(0, 2)
          let Ee = { ind: c, mode: f, doc: Lt(g) },
            N = g[0]
          on({ ind: c, mode: nt, doc: [S, P, N] }, [], h, p.length > 0, r, !0)
            ? i.push(Ee, d, v)
            : _
              ? i.push(Ee, U, v)
              : i.push(Ee, U, M)
        ...
        case We:
          ...
          break
        case Ge:
          p.length > 0 && i.push({ ind: c, mode: f, doc: wn })
          break
        case pe:
          switch (f) {
            case nt:
            ...
            case Se:
              if (p.length > 0) {
                i.push({ ind: c, mode: f, doc: l }, ...p.reverse()), (p.length = 0)
                break
              }
              l.literal
                ? c.root
                  ...
                  : (a.push(s), (u = 0))
                : ((u -= gs(a)), a.push(s + c.value), (u = c.length))
              break
          }
          break
        case Le:
    ...
    let y = a.indexOf(lr)
    if (y !== -1) {
      let c = a.indexOf(lr, y + 1),
        f = a.slice(0, y).join(''),
        l = a.slice(y + 1, c).join(''),
        h = a.slice(c + 1).join('')
      return { formatted: f + l + h, cursorNodeStart: f.length, cursorNodeText: l }
    }
  ...
  function pn(e, t, r) {
    ...
    let i = [],
      a = e.map(t, u),
      o = du(n)
    o && (a = a.map((D) => hs(D, { ...r, printWidth: Number.POSITIVE_INFINITY }).formatted)), i.push(Be, '`')
    let p = 0
    return (
      e.each(({ index: D, node: y }) => {
...
`)
        ...
        if (!o) {
          let S = n[u][D]
          ;(A(S) || R(S) || S.type === 'ConditionalExpression' || S.type === 'SequenceExpression' || Ae(S) || me(S)) &&
            (h = [E([F, h]), F])
        }
        let g =
          l === 0 &&
...
`)
  ...
  function Si(e) {
    let t = e('quasi')
    return tt(t.label && { tagged: !0, ...t.label }, [e('tag'), e('typeParameters'), Be, t])
  }
  function Rc(e, t, r) {
    let { node: n } = e,
    ...
    if (s.length > 1 || s.some((u) => u.length > 0)) {
      ...
      t.__inJestEach = !1
      let i = [],
        a = u.map((c) => '${' + hs(c, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: 'lf' }).formatted + '}'),
...
`) && o.push({ hasLineBreak: !1, cells: [] })
      ...
      let p = Math.max(s.length, ...o.map((c) => c.cells.length)),
        D = Array.from({ length: p }).fill(0),
        y = [{ cells: s }, ...o.filter((c) => c.cells.length > 0)]
      for (let { cells: c } of y.filter((f) => !f.hasLineBreak))
        for (let [f, l] of c.entries()) D[f] = Math.max(D[f], rt(l))
      return (
        i.push(
          Be,
          '`',
          E([
            ...
            b(
              ...
              y.map((c) =>
                b(
                  ' | ',
                  c.cells.map((f, l) => (c.hasLineBreak ? f : f + ' '.repeat(D[l] - rt(f))))
                )
              )
            )
          ]),
  ...
  function bi(e, t, r) {
    let { node: n } = e,
      s = Ie(t.originalText, J(n), J(n.typeParameter))
    return m(
      [
        '{',
        E([
  ...
  function bt(e, t, r, n) {
    ...
    let u = e.getNode(2),
      i = u && gt(u),
      a = e.match(
        (D) => !(D[n].length === 1 && we(D[n][0])),
        void 0,
        (D, y) => y === 'typeAnnotation',
        (D) => D.type === 'Identifier',
        Ds
      )
    if (
      s[n].length === 0 ||
      (!a && (i || (s[n].length === 1 && (s[n][0].type === 'NullableTypeAnnotation' || fs(s[n][0])))))
    )
      return ['<', b(', ', e.map(r, n)), Yc(e, t), '>']
    let p = s.type === 'TSTypeParameterInstantiation' ? '' : Gc(e, t, n) ? ',' : ye(t) ? B(',') : ''
    return m(['<', E([F, b([',', T], e.map(r, n))]), p, F, '>'], { id: mr(s) })
  }
  function Yc(e, t) {
    let { node: r } = e
  ...
  function mn(e, t, r) {
    ...
    if (
      ...
      n.out && u.push('out '),
      u.push(i),
      n.bound && (n.usesExtendsBound && u.push(' extends '), u.push(X(e, r, 'bound'))),
      n.constraint)
    ) {
      let a = Symbol('constraint')
      u.push(' extends', m(E(T), { id: a }), Be, Et(r('constraint'), { groupId: a }))
    }
  ...
  function yt(e, t, r) {
    ...
    if (
      (u.type === 'Identifier' ||
        (ke(u) &&
          $n(He(De(u))) &&
          String(u.value) === He(De(u)) &&
          !(t.parser === 'typescript' || t.parser === 'babel-ts'))) &&
      (t.parser === 'json' || (t.quoteProps === 'consistent' && Dn.get(s)))
    ) {
      let i = at(JSON.stringify(u.type === 'Identifier' ? u.name : u.value.toString()), t)
      return e.call((a) => ce(a, i, t), 'key')
    }
    return Nn(n, t) && (t.quoteProps === 'as-needed' || (t.quoteProps === 'consistent' && !Dn.get(s)))
      ? e.call((i) => ce(i, /^\d/.test(u.value) ? He(u.value) : u.value, t), 'key')
      : r('key')
  }
  function Pi(e, t, r) {
    let { node: n } = e
  ...
  var Nc = (e) =>
      ...
      ((e.type === 'Property' || e.type === 'ObjectProperty') && (e.method || e.kind === 'get' || e.kind === 'set')),
    $c = (e) => e.node.type === 'FunctionExpression' && e.key === 'value' && Nc(e.parent)
  function yn(e, t, r, n) {
    if ($c(e)) return fn(e, r, t)
    let { node: s } = e,
      u = !1
    ...
    let i = [re(e), s.async ? 'async ' : '', `function${s.generator ? '*' : ''} `, s.id ? t('id') : ''],
      a = mt(e, t, r, u),
      o = Fn(e, t),
      p = Bt(s, o)
    return (
      i.push(Ke(e, r, t), m([p ? m(a) : a, o]), s.body ? ' ' : '', t('body')),
  ...
  function Dr(e, t, r) {
    ...
    return (
      !s || s === 'init' || s === 'method' || s === 'constructor'
        ...
        : (un.ok(s === 'get' || s === 'set'), i.push(s, ' ')),
      u.generator && i.push('*'),
      i.push(yt(e, t, r), n.optional || n.key.optional ? '?' : '', n === u ? fn(e, t, r) : r('value')),
      i
    )
  }
  function fn(e, t, r) {
    let { node: n } = e,
      ...
      i = ui(n),
      a = Bt(n, u),
      o = [Ke(e, t, r), m([i ? m(s, { shouldBreak: !0 }) : a ? m(s) : s, u])]
  ...
  function ki(e, t, r) {
    ...
    let i = A(n, x.Dangling),
      a = s && i && A(n, x.Last | x.Line)
    return a && u.push(s), i && u.push(' ', j(e, t)), a || u.push(s), u
  }
  function Ii(e, t, r) {
    return ['return', ki(e, t, r)]
  }
  function Li(e, t, r) {
    return ['throw', ki(e, t, r)]
  }
  function Kc(e, t) {
  ...
  function Cn(e, t, r) {
    ...
    if ((n.id && i.push(' ', r('id')), i.push(r('typeParameters')), n.superClass)) {
      let o = [zc(e, t, r), r('superTypeParameters')],
        p = e.call((D) => ['extends ', ce(D, o, t)], 'superClass')
      u ? a.push(T, m(p)) : a.push(' ', p)
    } else a.push(bs(e, t, r, 'extends'))
    if ((a.push(bs(e, t, r, 'mixins'), bs(e, t, r, 'implements')), u)) {
      let o
      vi(n) ? (o = [...i, E(a)]) : (o = E([...i, a])), s.push(m(o, { id: wi(n) }))
    } else s.push(...i, ...a)
    return s.push(' ', r('body')), s
  }
  var wi = ln('heritageGroup')
  function Ps(e) {
    return B(C, '', { groupId: wi(e) })
  }
  function Hc(e) {
    return (
  ...
  function bs(e, t, r, n) {
    ...
    return [vi(s) ? B(' ', T, { groupId: mr(s.typeParameters) }) : T, u, u && C, n, m(E([T, b([',', T], e.map(r, n))]))]
  }
  function zc(e, t, r) {
    let n = r('superClass'),
      { parent: s } = e
    return s.type === 'AssignmentExpression' ? m(B(['(', E([F, n]), F, ')'], n)) : n
  }
  function An(e, t, r) {
    let { node: n } = e,
      s = []
    return (
      k(n.decorators) && s.push(Fs(e, t, r)),
      s.push(Wt(n)),
  ...
  function _i(e, t, r) {
    ...
    return (
      ...
      A(n, x.Dangling) && s.push(j(e, t)),
      [k(n.body) ? Ps(e.parent) : '', '{', s.length > 0 ? [E([C, s]), C] : '', '}']
    )
  }
  function Qc(e, t) {
    var s
  ...
  function Tt(e, t, r) {
    ...
    let o = a.flatMap((d) => e.map(({ node: U }) => ({ node: U, printed: r(), loc: J(U) }), d))
    a.length > 1 && o.sort((d, U) => d.loc - U.loc)
    let { parent: p, key: D } = e,
      y =
        u &&
        D === 'body' &&
        (p.type === 'InterfaceDeclaration' || p.type === 'DeclareInterface' || p.type === 'DeclareClass'),
      c =
        ...
        (s.type === 'ObjectPattern' &&
          ...
          p.type !== 'CatchClause' &&
          s.properties.some((d) => d.value && (d.value.type === 'ObjectPattern' || d.value.type === 'ArrayPattern'))) ||
        (s.type !== 'ObjectPattern' && o.length > 0 && Ie(t.originalText, J(s), o[0].loc)),
      f = y ? ';' : s.type === 'TSInterfaceBody' || s.type === 'TSTypeLiteral' ? B(n, ';') : ',',
      ...
      S = o.map((d) => {
        ...
        return (
          (g = [f, T]),
          (d.node.type === 'TSPropertySignature' ||
            d.node.type === 'TSMethodSignature' ||
            d.node.type === 'TSConstructSignatureDeclaration' ||
            d.node.type === 'TSCallSignatureDeclaration') &&
            A(d.node, x.PrettierIgnore) &&
            g.shift(),
          fe(d.node, t) && g.push(C),
          U
        )
      })
    if (s.inexact || s.hasUnknownMembers) {
      ...
      if (A(s, x.Dangling)) {
        let U = A(s, x.Line)
        d = [j(e, t), U || Q(t.originalText, L(w(!1, ot(s), -1))) ? C : T, '...']
      } else d = ['...']
      S.push([...g, ...d])
    }
    let P = (_ = w(!1, o, -1)) == null ? void 0 : _.node,
      v = !(
        s.inexact ||
        s.hasUnknownMembers ||
        (P &&
          (P.type === 'RestElement' ||
            ((P.type === 'TSPropertySignature' ||
              P.type === 'TSCallSignatureDeclaration' ||
              P.type === 'TSMethodSignature' ||
              P.type === 'TSConstructSignatureDeclaration') &&
              A(P, x.PrettierIgnore))))
      ),
      M
    if (S.length === 0) {
      if (!A(s, x.Dangling)) return [l, h, X(e, r)]
      M = m([l, j(e, t, { indent: !0 }), F, h, $(e), X(e, r)])
    } else
      M = [
        y && k(s.properties) ? Ps(p) : '',
        l,
        E([t.bracketSpacing ? T : F, ...S]),
        B(v && (f !== ',' || ye(t)) ? f : ''),
        t.bracketSpacing ? T : F,
        h,
        $(e),
    ...
    return e.match((d) => d.type === 'ObjectPattern' && !k(d.decorators), ks) ||
      (we(s) &&
        (e.match(
          void 0,
          (d, U) => U === 'typeAnnotation',
          (d, U) => U === 'typeAnnotation',
          ks
        ) ||
          e.match(void 0, (d, U) => d.type === 'FunctionTypeParam' && U === 'typeAnnotation', ks))) ||
      (!c &&
        e.match(
          (d) => d.type === 'ObjectPattern',
          (d) => d.type === 'AssignmentExpression' || d.type === 'VariableDeclarator'
        ))
      ? M
      : m(M, { shouldBreak: c })
  }
  ...
  function ji(e) {
    return (
      Is.has(e) || Is.set(e, e.type === 'ConditionalExpression' && !ie(e, (t) => t.type === 'ObjectExpression')),
      Is.get(e)
    )
  }
  ...
  function Ri(e, t, r, n = {}) {
    ...
    ;(function g() {
      ...
      if (s.length === 0) s.push(P)
        ...
        s.push([v, P]), i.unshift(M)
      }
      o &&
        (a || (a = (S.returnType && V(S).length > 0) || S.typeParameters || V(S).some((v) => v.type !== 'Identifier'))),
        !o || S.body.type !== 'ArrowFunctionExpression' ? ((u = r('body', n)), (p = S.body)) : e.call(g, 'body')
    })()
    let D = !ve(t.originalText, p) && (Mi(p) || el(p, u, t) || (!a && ji(p))),
      y = e.key === 'callee' && pt(e.parent),
      c = Symbol('arrow-chain'),
      f = tl(e, n, { signatureDocs: s, shouldBreak: a }),
      l,
      h = !1
    return (
      o && (y || n.assignmentLayout) && ((h = !0), (l = n.assignmentLayout === 'chain-tail-arrow-chain' || (y && !D))),
      (u = rl(e, t, n, { bodyDoc: u, bodyComments: i, functionBody: p, shouldPutBodyOnSameLine: D })),
      m([
        m(h ? E([F, f]) : f, { shouldBreak: l, id: c }),
        ' =>',
        o ? Et(u, { groupId: c }) : m(u),
        o && y ? B(F, '', { groupId: c }) : ''
      ])
    )
  }
  ...
  function tl(e, t, { signatureDocs: r, shouldBreak: n }) {
    ...
    return (u !== 'callee' && pt(s)) || me(s)
      ? m([r[0], ' =>', E([T, b([' =>', T], r.slice(1))])], { shouldBreak: n })
      : (u === 'callee' && pt(s)) || t.assignmentLayout
        ? m(b([' =>', T], r), { shouldBreak: n })
        : m(E(b([' =>', T], r)), { shouldBreak: n })
  }
  function rl(e, t, r, { bodyDoc: n, bodyComments: s, functionBody: u, shouldPutBodyOnSameLine: i }) {
    let { node: a, parent: o } = e,
      p = r.expandLastArg && ye(t, 'all') ? B(',') : '',
      D = (r.expandLastArg || o.type === 'JSXExpressionContainer') && !A(a) ? F : ''
    return i && ji(u)
      ? [' ', m([B('', '('), E([F, n]), B('', ')'), p, D]), s]
      : (Mi(u) && (n = m(['(', E([F, n]), F, ')'])), i ? [' ', n, s] : [E([T, n, s]), p, D])
  }
  function yr(e, t, r, n) {
    let { node: s } = e,
      u = [],
  ...
  function Ls(e, t, r) {
    ...
    let a = []
    return (
      s && (a.push(yr(e, t, r, 'directives')), (u || i) && (a.push(C), fe(w(!1, n.directives, -1), t) && a.push(C))),
      u && a.push(yr(e, t, r, 'body')),
      i && a.push(j(e, t)),
      n.type === 'Program' && ((o = e.parent) == null ? void 0 : o.type) !== 'ModuleExpression' && a.push(C),
      a
    )
  }
  function Ui(e, t) {
  ...
  function Gi(e, t) {
    ...
    return he(e, t) ? !0 : Mt(r) ? e.call(() => Gi(e, t), ...wr(r)) : !1
  }
  ...
  function Yi(e, t, r) {
    let n = [r('expression')]
    return (
      vs(e, t) ? ws(e.node.expression) && n.push(';') : Os(e, t) || (t.semi && n.push(';')),
      A(e.node, x.Dangling, ({ marker: s }) => s === ir) && n.push(' ', j(e, t, { marker: ir })),
      n
    )
  }
  function Xi(e, t, r) {
    if (t.__isVueBindings || t.__isVueForBindingLeft) {
      ...
      let s = b([',', T], n)
      return t.__isVueForBindingLeft ? ['(', E([F, m(s)]), F, ')'] : s
    }
  ...
  function Ni(e, t, r, n) {
    ...
    switch (s.type) {
      ...
      case 'BindExpression':
        return s.object && i.push(r('object')), i.push(m(E([F, Wr(e, t, r)]))), i
      case 'Identifier':
        return [s.name, $(e), nn(e), X(e, r)]
      ...
      case 'SequenceExpression': {
        ...
        if (a.type === 'ExpressionStatement' || a.type === 'ForStatement') {
          ...
          return (
            e.each(({ isFirst: p }) => {
              p ? o.push(r()) : o.push(',', E([T, r()]))
            }, 'expressions'),
            m(o)
          )
        }
        return m(b([',', T], e.map(r, 'expressions')))
      }
      case 'ThisExpression':
        return 'this'
      case 'Super':
      ...
      case 'UnaryExpression':
        return (
          ...
          A(s.argument) ? i.push(m(['(', E([F, r('argument')]), F, ')'])) : i.push(r('argument')),
          i
        )
      case 'UpdateExpression':
      ...
      case 'VariableDeclaration': {
        let a = e.map(r, 'declarations'),
          ...
          D = s.declarations.some((c) => c.init),
          y
        return (
          a.length === 1 && !A(s.declarations[0]) ? (y = a[0]) : a.length > 0 && (y = E(a[0])),
          (i = [re(e), s.kind, y ? [' ', y] : '', E(a.slice(1).map((c) => [',', D && !p ? C : T, c]))]),
          (p && o.body !== s) || i.push(u),
          m(i)
        )
      }
      case 'WithStatement':
        return m(['with (', r('object'), ')', Dt(s.body, r('body'))])
      case 'IfStatement': {
        let a = Dt(s.consequent, r('consequent')),
          o = m(['if (', m([E([F, r('test')]), F]), ')', a])
        if ((i.push(o), s.alternate)) {
          let p = A(s.consequent, x.Trailing | x.Line) || jr(s),
            D = s.consequent.type === 'BlockStatement' && !p
          i.push(D ? ' ' : C),
            A(s, x.Dangling) && i.push(j(e, t), p ? C : ' '),
            i.push('else', m(Dt(s.alternate, r('alternate'), s.alternate.type === 'IfStatement')))
        }
        return i
      }
      case 'ForStatement': {
        ...
        return !s.init && !s.test && !s.update
          ? [p, m(['for (;;)', a])]
          : [p, m(['for (', m([E([F, r('init'), ';', T, r('test'), ';', T, r('update')]), F]), ')', a])]
      }
      case 'WhileStatement':
        return m(['while (', m([E([F, r('test')]), F]), ')', Dt(s.body, r('body'))])
      case 'ForInStatement':
        return m(['for (', r('left'), ' in ', r('right'), ')', Dt(s.body, r('body'))])
      case 'ForOfStatement':
        return m(['for', s.await ? ' await' : '', ' (', r('left'), ' of ', r('right'), ')', Dt(s.body, r('body'))])
      case 'DoWhileStatement': {
        let a = Dt(s.body, r('body'))
        return (
          (i = [m(['do', a])]),
          s.body.type === 'BlockStatement' ? i.push(' ') : i.push(C),
          i.push('while (', m([E([F, r('test')]), F]), ')', u),
          i
        )
      }
      case 'DoExpression':
      ...
      case 'ContinueStatement':
        return (
          i.push(s.type === 'BreakStatement' ? 'break' : 'continue'), s.label && i.push(' ', r('label')), i.push(u), i
        )
      ...
      case 'CatchClause':
        if (s.param) {
          let a = A(
              ...
              (p) =>
                !Z(p) ||
                (p.leading && Q(t.originalText, L(p))) ||
                (p.trailing && Q(t.originalText, J(p), { backwards: !0 }))
            ),
            o = r('param')
        ...
        return [
          ...
          s.cases.length > 0
            ? E([
                ...
                b(
                  C,
                  e.map(({ node: a, isLast: o }) => [r(), !o && fe(a, t) ? C : ''], 'cases')
                )
              ])
            : '',
          C,
      ...
      case 'SwitchCase': {
        ...
        if (a.length > 0) {
          ...
          i.push(a.length === 1 && a[0].type === 'BlockStatement' ? [' ', o] : E([C, o]))
        }
        return i
      }
  ...
  function Vi(e, t, r) {
    ...
    if (n.type.startsWith('NG'))
      switch (n.type) {
        case 'NGRoot':
          return [r('node'), A(n.node) ? ' //' + ot(n.node)[0].value.trimEnd() : '']
        case 'NGPipeExpression':
          return Ur(e, t, r)
        case 'NGChainedExpression':
          return m(
            b(
              [';', T],
              e.map(() => (il(e) ? r() : ['(', r(), ')']), 'expressions')
            )
          )
        case 'NGEmptyExpression':
          return ''
        case 'NGMicrosyntax':
          return e.map(() => [e.isFirst ? '' : $i(e) ? ' ' : [';', T], r()], 'body')
        ...
        case 'NGMicrosyntaxKeyedExpression': {
          let { index: s, parent: u } = e,
            i =
              $i(e) ||
              (((s === 1 && (n.key.name === 'then' || n.key.name === 'else' || n.key.name === 'as')) ||
                (s === 2 &&
                  ((n.key.name === 'else' &&
  ...
  var ul = q(['CallExpression', 'OptionalCallExpression', 'AssignmentExpression'])
  function il({ node: e }) {
    return er(e, ul)
  }
  function gn(e, t, r) {
    let { parent: n, node: s } = e,
      u = []
    switch (s.type) {
      case 'AsConstExpression':
        u = [r('expression'), ' as const']
        break
      case 'AsExpression':
      case 'TSAsExpression':
        u = [r('expression'), ' ', 'as', ' ', r('typeAnnotation')]
        break
      case 'SatisfiesExpression':
      case 'TSSatisfiesExpression':
        u = [r('expression'), ' ', 'satisfies', ' ', r('typeAnnotation')]
        break
    }
    return (I(n) && n.callee === s) || (R(n) && n.object === s) ? m([E([F, ...u]), F]) : u
  }
  function hn(e, t, r) {
    let { node: n } = e,
      s = [re(e), 'interface'],
    ...
    return (
      k(n.extends) &&
        i.push(
          a ? B(' ', T, { groupId: mr(n.typeParameters) }) : T,
          'extends ',
          (n.extends.length === 1 ? Su : E)(b([',', T], e.map(r, 'extends')))
        ),
      A(n.id, x.Trailing) || k(n.extends)
        ? a
          ? s.push(m([...u, E(i)]))
          : s.push(m(E([...u, ...i])))
        : s.push(...u, ...i),
  ...
  function zi(e, t, r) {
    let { node: n } = e
    if (Ir(n)) return n.type.slice(0, -14).toLowerCase()
    let s = t.semi ? ';' : ''
    switch (n.type) {
      case 'DeclareClass':
        return Cn(e, t, r)
      case 'DeclareFunction':
        return [re(e), 'function ', r('id'), r('predicate'), s]
      case 'DeclareModule':
        return ['declare module ', r('id'), ' ', r('body')]
      case 'DeclareModuleExports':
        return ['declare module.exports', X(e, r), s]
      case 'DeclareVariable':
        return [re(e), n.kind ?? 'var', ' ', r('id'), s]
      ...
      case 'GenericTypeAnnotation':
        return [r('id'), bt(e, t, r, 'typeParameters')]
      ...
      case 'Variance': {
        let { kind: u } = n
        return un.ok(u === 'plus' || u === 'minus'), u === 'plus' ? '+' : '-'
      }
      ...
      case 'BigIntLiteralTypeAnnotation':
        return xn(n.raw ?? n.extra.raw)
      case 'TypeCastExpression':
        return ['(', r('expression'), X(e, r), ')']
      case 'TypePredicate':
        return rn(e, r)
  ...
  function Qi(e, t, r) {
    ...
    if (Lr(n)) return n.type.slice(2, -7).toLowerCase()
    let s = t.semi ? ';' : '',
      u = []
    switch (n.type) {
      case 'TSThisType':
        return 'this'
      case 'TSTypeAssertion': {
        let a = !(G(n.expression) || se(n.expression)),
          o = m(['<', E([F, r('typeAnnotation')]), F, '>']),
      ...
      case 'TSPropertySignature':
        return [n.readonly ? 'readonly ' : '', yt(e, t, r), $(e), X(e, r)]
      ...
      case 'TSTypeQuery':
        return tn(e, r)
      case 'TSIndexSignature': {
        let a = n.parameters.length > 1 ? B(ye(t) ? ',' : '') : '',
          o = m([E([F, b([', ', F], e.map(r, 'parameters'))]), a, F]),
      ...
      case 'TSModuleDeclaration': {
        ...
        if (o) u.push('.')
          ...
          let y =
            n.kind ??
            (ee(n.id) || /(?:^|\s)module(?:\s|$)/.test(t.originalText.slice(J(n), J(n.id))) ? 'module' : 'namespace')
          u.push(y, ' ')
        }
      ...
      case 'TSTypeReference':
        return [r('typeName'), bt(e, t, r, 'typeParameters')]
  ...
  function al(e, t, r, n) {
    if (qr(e)) return Ns(e, t)
    for (let s of [Vi, $u, zi, Qi, Ni]) {
      let u = s(e, t, r, n)
  ...
  function pl(e, t, r, n) {
    ...
    let { node: u } = e
    if (ol(u)) return s
    let i = k(u.decorators),
      a = ci(e, t, r),
      o = u.type === 'ClassExpression'
    if (i && !o) return Ht(s, (c) => m([a, c]))
    let p = he(e, t),
      D = Wi(e, t)
    return !a && !p && !D
      ? s
      : Ht(s, (c) => [D ? ';' : '', p ? '(' : '', p && o && i ? [E([T, a, c]), T] : [a, c], p ? ')' : ''])
  }
  var Zi = pl
  var ta = [
  ...
  function ra(e) {
    return e.match(
      ...
      (t, r) => G(t) && r === 'elements',
      (t, r) => Ce(t) && t.key.type === 'Identifier' && t.key.name === 'styles' && r === 'value',
      ...ta
    )
  }
  function na(e) {
    return e.match(
      (t) => t.type === 'TemplateLiteral',
      (t, r) => Ce(t) && t.key.type === 'Identifier' && t.key.name === 'template' && r === 'value',
      ...ta
    )
  }
  function ea(e, t) {
  ...
  async function ll(e, t, r) {
    let { node: n } = r,
      s = n.quasis.map((D) => D.value.raw),
      u = 0,
      i = s.reduce((D, y, c) => (c === 0 ? y : D + '@prettier-placeholder-' + u++ + '-id' + y), ''),
    ...
    let r = 0,
      n = it(Ot(e), (s) =>
        typeof s != 'string' || !s.includes('@prettier-placeholder')
          ? s
          : s.split(/@prettier-placeholder-(\d+)-id/).map((u, i) => (i % 2 === 0 ? be(u) : (r++, t[u])))
      )
  ...
  function yl({ parent: e }) {
    ...
    switch (t.type) {
      case 'MemberExpression':
        return Pn(t.object) || sa(t)
      case 'CallExpression':
        return (
          Pn(t.callee) ||
          (t.callee.type === 'MemberExpression' &&
            ((t.callee.object.type === 'MemberExpression' && (Pn(t.callee.object.object) || sa(t.callee.object))) ||
              (t.callee.object.type === 'CallExpression' && Pn(t.callee.object.callee))))
        )
      case 'Identifier':
        return t.name === 'css'
      default:
...
`),
      ...
      let P = null
      S ? (P = Cl(c)) : (P = await e(y, { parser: 'graphql' })),
        P ? ((P = cn(P, !1)), !p && h && i.push(''), i.push(P), !D && g && i.push('')) : !p && !D && h && i.push(''),
        l && i.push(l)
    }
    return ['`', E([C, b(C, i)]), C, '`']
  }
  function Cl(e) {
    let t = [],
      r = !1,
      n = e.map((s) => s.trim())
    for (let [s, u] of n.entries()) u !== '' && (n[s - 1] === '' && r ? t.push([C, u]) : t.push(u), (r = !0))
    return t.length === 0 ? null : b(C, t)
  }
  function Al({ node: e, parent: t }) {
    return (
      bn({ node: e, parent: t }, 'GraphQL') ||
      (t &&
        ((t.type === 'TaggedTemplateExpression' &&
          ((t.tag.type === 'MemberExpression' &&
          ...
          (t.type === 'CallExpression' && t.callee.type === 'Identifier' && t.callee.name === 'graphql')))
    )
  }
  function Tl(e) {
    if (Al(e)) return Fl
  ...
  async function aa(e, t, r, n, s) {
    ...
    let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`,
      o = u.quasis.map((S, P, v) => (P === v.length - 1 ? S.value.cooked : S.value.cooked + a(P))).join(''),
      p = Yt(n, r),
      D = new RegExp(a('(\\d+)'), 'g'),
      y = 0,
      c = await t(o, {
      ...
      l = /^\s/.test(o) ? ' ' : '',
      h = /\s$/.test(o) ? ' ' : '',
      g = s.htmlWhitespaceSensitivity === 'ignore' ? C : l && h ? T : null
    return g ? m(['`', E([g, m(f)]), g, '`']) : tt({ hug: !1 }, m(['`', l, y > 1 ? E(m(f)) : m(f), h, '`']))
  }
  function dl(e) {
    return (
      bn(e, 'HTML') ||
      e.match(
        (t) => t.type === 'TemplateLiteral',
        (t, r) =>
          t.type === 'TaggedTemplateExpression' && t.tag.type === 'Identifier' && t.tag.name === 'html' && r === 'quasi'
      )
    )
  }
  var xl = aa.bind(void 0, 'html'),
    gl = aa.bind(void 0, 'angular')
  function hl(e) {
    if (dl(e)) return xl
    if (na(e)) return gl
  }
  ...
  async function Sl(e, t, r) {
    let { node: n } = r,
      s = K(!1, n.quasis[0].value.raw, /((?:\\\\)*)\\`/g, (o, p) => '\\'.repeat(p.length / 2) + '`'),
      u = Bl(s),
      i = u !== ''
    i && (s = K(!1, s, new RegExp(`^${u}`, 'gm'), ''))
    let a = cn(await e(s, { parser: 'markdown', __inJsTemplate: !0 }), !0)
    return ['`', i ? E([F, a]) : [gr, Ks(a)], F, '`']
  }
  function Bl(e) {
    let t = e.match(/^([^\S\n]*)\S/m)
    return t === null ? '' : t[1]
  ...
  function kl(e) {
    ...
    let r
    for (let n of [ua, ia, oa, pa])
      if (((r = n(e)), !!r))
        return t.quasis.length === 1 && t.quasis[0].value.raw.trim() === ''
          ? '``'
          : async (...s) => {
              let u = await r(...s)
              return u && tt({ embed: !0, ...u.label }, u)
            }
  }
  ...
  function la(e, t, r) {
    ...
    if (
      ...
      (e.type === 'BigIntLiteral' || e.type === 'Literal') && t.bigint && (t.bigint = t.bigint.toLowerCase()),
    ...
    if (
      ...
      e.type === 'TemplateLiteral' &&
        (((u = e.leadingComments) != null &&
          u.some((a) => Z(a) && ['GraphQL', 'HTML'].some((o) => a.value === ` ${o} `))) ||
          (r.type === 'CallExpression' && r.callee.name === 'graphql') ||
          !e.leadingComments) &&
        Xt(t),
      (e.type === 'TSIntersectionType' || e.type === 'TSUnionType') && e.types.length === 1)
    )
      return t.types[0]
    e.type === 'ChainExpression' &&
...
`)
  ...
  function Wl(e) {
    ...
    let r = (0, dt.extract)(e),
      { pragmas: n, comments: s } = (0, dt.parseWithComments)(r)
    return { shebang: t, text: e, pragmas: n, comments: s }
  }
  function da(e) {
    let { shebang: t, text: r, pragmas: n, comments: s } = Wl(e),
      u = (0, dt.strip)(r),
      i = (0, dt.print)({ pragmas: { format: '', ...n }, comments: s.trimStart() })
    return (
      (t
        ? `${t}
`
...
`) +
  ...
  var Ms = {}
  Ar(Ms, { getVisitorKeys: () => ha, massageAstNode: () => Ba, print: () => Nl })
  var Yl = {
      JsonRoot: ['node'],
      ArrayExpression: ['elements'],
      ObjectExpression: ['properties'],
  ...
  function Nl(e, t, r) {
    ...
    switch (n.type) {
      ...
      case 'ObjectExpression':
        return n.properties.length === 0 ? '{}' : ['{', E([C, b([',', C], e.map(r, 'properties'))]), C, '}']
      case 'ObjectProperty':
        return [r('key'), ': ', r('value')]
      case 'UnaryExpression':
  ...
  var kt = 'JavaScript',
    Vl = {
      ...
      jsxSingleQuote: { category: kt, type: 'boolean', default: !1, description: 'Use single quotes in JSX.' },
      quoteProps: {
        category: kt,
        type: 'choice',
        default: 'as-needed',
    ...
    Pa = Vl
  var Kl = { estree: js, 'estree-json': Ms },
    Hl = [...xa, ...ba]
  return qa(zl)
})
